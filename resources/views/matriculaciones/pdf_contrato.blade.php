    ...
    @section('pdf_content')
        ...
        <div class="pagina">
            ...
            <div id="estudiante_parrafo">
                <table class="tabla_estudiante">
                    <tbody>
                        <tr>
                            <td class="izquierda">Programa Académico:</td>
                            <td class="derecha">{{$matriculacion->programa->nombre}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Carrera:</td>
                            <td class="derecha">{{$matriculacion->carrera->nombre_real}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Créditos del programa:</td>
                            <td class="derecha">{{$total_creditos}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Duración del programa:</td>
                            <td class="derecha">{{$duracion_carrera}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Formación Académica del postulante:</td>
                            <td class="derecha">{{$matriculacion->alumno->formacion->nombre}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Institución de procedencia:</td>
                            <td class="derecha">{{$matriculacion->alumno->institucionEducativa->nombre}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Periodo de ingreso:</td>
                            <td class="derecha">{{$matriculacion->semestre->nombre}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="derecha">{{$matriculacion->alumno->numero_documento}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Correo Personal:</td>
                            <td class="derecha">{{$matriculacion->alumno->email_personal}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Teléfono / Celular:</td>
                            <td class="derecha">@if ($matriculacion->alumno->telefono) {{$matriculacion->alumno->telefono}} / @endif {{$matriculacion->alumno->celular}}</td>
                        </tr>
                    </tbody>
                </table>
                <br>
                ...
                <table class="tabla_estudiante">
                    <tbody>
                        <tr>
                            ...
                            <td class="derecha">{{$matriculacion->alumno->direccion}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Barrio:</td>
                            <td class="derecha">{{$matriculacion->alumno->barrio->nombre}}</td>
                        </tr>
                        <tr>
                            <td class="izquierda">Ciudad:</td>
                            <td class="derecha">{{$matriculacion->alumno->ciudad->nombre}}</td>
                        </tr>
                    </tbody>
                </table>
                <br>
                ...
                <table class="tabla_estudiante">
                    @php
                        foreach ($matriculacion->alumno->alumnoClientes as $cliente) {
                ...
                <table class="tabla_estudiante">
                    <tbody>
                        <tr>
                            ...
                            <td class="derecha">
                                @if ($matriculacion->alumno->dato_laboral_id)
                                    {{$matriculacion->alumno->datoLaboral->empresa}}
                                @else
                        ...
                        <tr>
                            ...
                            <td class="derecha">
                                @if ($matriculacion->alumno->dato_laboral_id)
                                    {{$matriculacion->alumno->datoLaboral->telfono}}
                                @else
                                    ________________________________________________
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="derecha">
                                @if ($matriculacion->alumno->dato_laboral_id)
                                    {{$matriculacion->alumno->datoLaboral->email}}
                                @else
                                    ________________________________________________
                                @endif
                                </td>
                ...
                <table class="tabla_estudiante">
                    @php
                        if ($matriculacion->alumno->familiar_uno_id) {
                            $relacion = Str::title($matriculacion->alumno->familiarUno->relacion->nombre);
                        }
                    @endphp
                    <tbody>
                        <tr>
                            ...
                            <td class="derecha">
                                @if ($matriculacion->alumno->familiar_uno_id)
                                    {{$matriculacion->alumno->familiarUno->primer_nombre}} {{$matriculacion->alumno->familiarUno->primer_apellido}}
                                @else
                                    ________________________________________________
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="derecha">
                                @if ($matriculacion->alumno->familiar_uno_id)
                                    {{$matriculacion->alumno->familiarUno->celular}}
                                @else
                                    ________________________________________________
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="derecha">
                                @if ($matriculacion->alumno->familiar_uno_id)
                                    {{$matriculacion->alumno->familiarUno->email}}
                                @else
                                    ________________________________________________
                                @endif
                            </td>
        ...
        <div class="pagina">
            ...
            <table class="tabla_estudiante">
                <tbody>
                    <tr>
                        <td><input type="checkbox" class="checkbox" id="checkbox" @if ($matriculacion->licenciatura == true) checked @endif></td>
                        <td>
        ...
        <div class="pagina">
            ...
            <table class="tabla_aranceles">
                <tbody>
                    <tr>
                        <td class="aranceles_checkbox"><input type="checkbox" class="checkbox" id="checkbox" @if ($matriculacion->licenciatura == true) checked @endif></td>
                    ...
                    <tr>
                        <td class="aranceles_izquierda" colspan="2">Monto de matrícula por semestre: @if ($matriculacion->licenciatura == true) {{$precios['precio_matricula']}} @endif</td>
                        <td class="aranceles_derecha" colspan="2">Precio General/Valor Contado: Gs. </td>
                    </tr>
                    <tr>
                        <td class="aranceles_izquierda" colspan="2">Número de matrículas: @if ($matriculacion->licenciatura == true) {{$precios['numero_matriculas']}} @endif</td>
                        <td class="aranceles_derecha" colspan="2">Financiación: </td>
                    </tr>
                    <tr>
                        <td class="aranceles_izquierda" colspan="2">Monto de cuota: @if ($matriculacion->licenciatura == true) {{$precios['precio_cuotas']}} @endif</td>
                        <td class="aranceles_derecha" colspan="2">Importe Defensa de Tesis + Titulación: </td>
                    </tr>
                    <tr>
                        <td class="aranceles_izquierda" colspan="2">Número de cuotas por semestre: @if ($matriculacion->licenciatura == true) {{$precios['numero_cuotas']}} @endif</td>
            ...
            <table class="tabla_estudiante">
                <tbody>
                    <tr>
                        <td>Forma de Pago:</td>
                        <td>Contado</td>
                        <td><input type="checkbox" class="checkbox" id="checkbox" @if ($matriculacion->tipo_pago == 'CO') checked @endif></td>
                        <td>Mensual</td>
                        <td><input type="checkbox" class="checkbox" id="checkbox" @if ($matriculacion->tipo_pago == 'CR') checked @endif></td>
