@can('crear_articulos')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Agregar Artículo  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('articulos.store')}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3 text-center">
                                    ...
                                    <div class="btn-group @error('compra_venta') is-invalid @enderror" role="group">
                                        <input type="radio" class="btn-check compra_venta1" id="compra_venta1" name="compra_venta" value="compra" @if (old('compra_venta') == 'compra') checked @endif>
                                        <label class="btn btn-outline-info" for="compra_venta1">Compra</label>
                                        <input type="radio" class="btn-check compra_venta2" id="compra_venta2" name="compra_venta" value="venta" @if (old('compra_venta') == 'venta') checked @endif>
                                ...
                                <div class="col-lg-2 mb-3 text-center">
                                    ...
                                    <div class="btn-group @error('stock') is-invalid @enderror" role="group">
                                        <input type="radio" class="btn-check stock1" id="stock1" name="stock" value="false" @if (old('stock') == 'false' || old('stock') == null) checked @endif>
                                        <label class="btn btn-outline-danger" for="stock1">No</label>
                                        <input type="radio" class="btn-check stock2" id="stock2" name="stock" value="true" @if (old('stock') == 'true') checked @endif>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <select class="form-control selectpicker @error('subcentro_costo') is-invalid @enderror" id="subcentro_costo" name="subcentro_costo" data-live-search="true" disabled>
                                        <option value="" selected disabled>Seleccionar...</option>
                                        
                                    </select>
                                    @error('subcentro_costo')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-lg-2 mb-3 d-none" id="div-cuenta_compra">
                                    ...
                                    <select class="form-control selectpicker @error('cuenta_compra') is-invalid @enderror" id="cuenta_compra" name="cuenta_compra" data-live-search="true">
                                        ...
                                        @foreach ($cuentas_contables as $cuenta_compra)
                                            <option value="{{$cuenta_compra->id}}" @if (old('cuenta_compra') == strval($cuenta_compra->id)) selected @endif data-subtext="{{$cuenta_compra->cuenta}}">{{$cuenta_compra->nombre}}</option>
                                        @endforeach
                                    </select>
                                    @error('cuenta_compra')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-2 mb-3 text-center @if (old('compra_venta') == 'compra') d-none @endif" id="div-carrera_curso">
                                    <div>
                                    ...
                                    <div class="btn-group @error('carrera_curso') is-invalid @enderror" role="group">
                                        <input type="radio" class="btn-check carrera_curso1" id="carrera_curso1" name="carrera_curso" value="carrera" @if (old('carrera_curso') == 'carrera') checked @endif>
                                        <label class="btn btn-outline-info" for="carrera_curso1">Carrera</label>
                                        <input type="radio" class="btn-check carrera_curso2" id="carrera_curso2" name="carrera_curso" value="curso" @if (old('carrera_curso') == 'curso') checked @endif>
                                ...
                                <div class="col-lg-3 mb-3 @if(old('carrera_curso') != 'carrera') d-none @endif" id="div-carrera">
                                ...
                                <div class="col-lg-3 mb-3 @if(old('carrera_curso') != 'curso') d-none @endif" id="div-curso">
                    ...
                    <div class="row @if (old('compra_venta') != 'venta') d-none @endif" id="row-precios">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control precios text-center @error('precio_matricula') is-invalid @enderror" id="precio_matricula" name="precio_matricula" value="{{old('precio_matricula')}}">
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_contado') is-invalid @enderror" id="precio_contado" name="precio_contado" value="{{old('precio_contado')}}">
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_cuota') is-invalid @enderror" id="precio_cuota" name="precio_cuota" value="{{old('precio_cuota')}}">
                                                @error('precio_cuota')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{$message}}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control precios cantidad_cuotas text-center @error('cantidad_cuotas') is-invalid @enderror" id="cantidad_cuotas" name="cantidad_cuotas" value="{{old('cantidad_cuotas')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_defensa') is-invalid @enderror" id="precio_defensa" name="precio_defensa" value="{{old('precio_defensa')}}">
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_titulo') is-invalid @enderror" id="precio_titulo" name="precio_titulo" value="{{old('precio_titulo')}}">
                                                @error('precio_titulo')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{$message}}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_certificado') is-invalid @enderror" id="precio_certificado" name="precio_certificado" value="{{old('precio_certificado')}}">
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_multa') is-invalid @enderror" id="precio_multa" name="precio_multa" value="{{old('precio_multa')}}">
                                                @error('precio_multa')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{$message}}</strong>
                                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_examen_suficiencia') is-invalid @enderror" id="precio_examen_suficiencia" name="precio_examen_suficiencia" value="{{old('precio_examen_suficiencia')}}">
                                        ...
                                        <div class="col-lg-3 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">Gs.</span>
                                                <input type="text" class="form-control precios text-center @error('precio_constancia_carrera') is-invalid @enderror" id="precio_constancia_carrera" name="precio_constancia_carrera" value="{{old('precio_constancia_carrera')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mb-3 text-center">
                                            ...
                                            <div class="form-icon right">
                                                <input type="text" class="form-control vencimientos flatpickr text-center form-control-icon @error('fecha_vencimiento_primera_cuota') is-invalid @enderror" id="fecha_vencimiento_primera_cuota" name="fecha_vencimiento_primera_cuota" value="{{old('fecha_vencimiento_primera_cuota')}}">
                                        ...
                                        <div class="col-lg-4 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control vencimientos text-center @error('dia_vencimiento_cuotas') is-invalid @enderror" id="dia_vencimiento_cuotas" name="dia_vencimiento_cuotas" value="{{old('dia_vencimiento_cuotas')}}">
                                        ...
                                        <div class="col-lg-4 mb-3 text-center">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control vencimientos text-center @error('dias_gracia') is-invalid @enderror" id="dias_gracia" name="dias_gracia" value="{{old('dias_gracia')}}">
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_matricula') is-invalid @enderror" id="cuenta_matricula" name="cuenta_matricula" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_matricula)
                                                    <option value="{{$cuenta_matricula->id}}" @if (old('cuenta_matricula') == strval($cuenta_matricula->id)) selected @endif data-subtext="{{$cuenta_matricula->cuenta}}">{{$cuenta_matricula->nombre}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_contado') is-invalid @enderror" id="cuenta_contado" name="cuenta_contado" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_contado)
                                                    <option value="{{$cuenta_contado->id}}" @if (old('cuenta_contado') == strval($cuenta_contado->id)) selected @endif data-subtext="{{$cuenta_contado->cuenta}}">{{$cuenta_contado->nombre}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_cuota') is-invalid @enderror" id="cuenta_cuota" name="cuenta_cuota" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_cuota)
                                                    <option value="{{$cuenta_cuota->id}}" @if (old('cuenta_cuota') == strval($cuenta_cuota->id)) selected @endif data-subtext="{{$cuenta_cuota->cuenta}}">{{$cuenta_cuota->nombre}}</option>
                                                @endforeach
                                            </select>
                                            @error('cuenta_cuota')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_descuento') is-invalid @enderror" id="cuenta_descuento" name="cuenta_descuento" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_descuento)
                                                    <option value="{{$cuenta_descuento->id}}" @if (old('cuenta_descuento') == strval($cuenta_descuento->id)) selected @endif data-subtext="{{$cuenta_descuento->cuenta}}">{{$cuenta_descuento->nombre}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_defensa') is-invalid @enderror" id="cuenta_defensa" name="cuenta_defensa" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_defensa)
                                                    <option value="{{$cuenta_defensa->id}}" @if (old('cuenta_defensa') == strval($cuenta_defensa->id)) selected @endif data-subtext="{{$cuenta_defensa->cuenta}}">{{$cuenta_defensa->nombre}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_titulo') is-invalid @enderror" id="cuenta_titulo" name="cuenta_titulo" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_titulo)
                                                    <option value="{{$cuenta_titulo->id}}" @if (old('cuenta_titulo') == strval($cuenta_titulo->id)) selected @endif data-subtext="{{$cuenta_titulo->cuenta}}">{{$cuenta_titulo->nombre}}</option>
                                                @endforeach
                                            </select>
                                            @error('cuenta_titulo')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_certificado') is-invalid @enderror" id="cuenta_certificado" name="cuenta_certificado" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_certificado)
                                                    <option value="{{$cuenta_certificado->id}}" @if (old('cuenta_certificado') == strval($cuenta_certificado->id)) selected @endif data-subtext="{{$cuenta_certificado->cuenta}}">{{$cuenta_certificado->nombre}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_multa') is-invalid @enderror" id="cuenta_multa" name="cuenta_multa" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_multa)
                                                    <option value="{{$cuenta_multa->id}}" @if (old('cuenta_multa') == strval($cuenta_multa->id)) selected @endif data-subtext="{{$cuenta_multa->cuenta}}">{{$cuenta_multa->nombre}}</option>
                                                @endforeach
                                            </select>
                                            @error('cuenta_multa')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_examen_suficiencia') is-invalid @enderror" id="cuenta_examen_suficiencia" name="cuenta_examen_suficiencia" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_examen_suficiencia)
                                                    <option value="{{$cuenta_examen_suficiencia->id}}" @if (old('cuenta_examen_suficiencia') == strval($cuenta_examen_suficiencia->id)) selected @endif data-subtext="{{$cuenta_examen_suficiencia->cuenta}}">{{$cuenta_examen_suficiencia->nombre}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <select class="form-control selectpicker cuentas @error('cuenta_constancia_carrera') is-invalid @enderror" id="cuenta_constancia_carrera" name="cuenta_constancia_carrera" data-live-search="true">
                                                ...
                                                @foreach ($cuentas_contables as $cuenta_constancia_carrera)
                                                    <option value="{{$cuenta_constancia_carrera->id}}" @if (old('cuenta_constancia_carrera') == strval($cuenta_constancia_carrera->id)) selected @endif data-subtext="{{$cuenta_constancia_carrera->cuenta}}">{{$cuenta_constancia_carrera->nombre}}</option>
                                                @endforeach
                                            </select>
    ...
    @section('script')
        ...
        @include('articulos.scripts.create-scripts')
    @endsection
@endcan
