@can('ver_anulaciones_correlatividades')
    ...
    @section('title') Anulaciones de Correlatividades @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Anulaciones de Correlatividades @endslot
        @endcomponent

        @include('anulaciones_correlatividades.scripts.messages-scripts')
        @include('anulaciones_correlatividades.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Anulaciones de Correlatividades</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="cajas-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="cajas-list">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ninguna anulación según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('anulaciones_correlatividades.scripts.index-scripts')
    @endsection
@endcan
