            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <label class="form-label" for="proveedor-show">Proveedor</label>
                        <input type="text" class="form-control" id="proveedor-show" readonly>
                    </div>
                    <div class="col-lg-6 mb-3">
...
<!-- createModal -->
    @can('crear_timbrados_proveedores')
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                        ...
                                        <select class="form-control selectpicker @error('proveedor') is-invalid @enderror" id="proveedor" name="proveedor" data-live-search="true">
                                            <option value="" selected disabled>Seleccionar...</option>
                                            @foreach ($proveedores as $proveedor)
                                                <option value="{{$proveedor->id}}" @if (old('proveedor') == strval($proveedor->id)) selected @endif>{{$proveedor->razon_social}}</option>
                                            @endforeach
                                        </select>
                                        @error('proveedor')
                ...
                <div class="modal-content">
                    <form id="update-form">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <label class="form-label" for="proveedor-edit">Proveedor <span class="text-danger">(*)</span></label>
                                    <select class="form-control @error('proveedor') is-invalid @enderror" id="proveedor-edit" name="proveedor" data-live-search="true">
