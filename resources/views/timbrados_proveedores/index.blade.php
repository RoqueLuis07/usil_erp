@can('ver_timbrados_proveedores')
    ...
    @section('title') Timbrados de Proveedores @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Timbrados de Proveedores @endslot
        @endcomponent

        @include('timbrados_proveedores.scripts.messages-scripts')
        @include('timbrados_proveedores.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Timbrados de Proveedores</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ningún timbrado de proveedor según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('timbrados_proveedores.scripts.index-scripts')
    @endsection
@endcan
