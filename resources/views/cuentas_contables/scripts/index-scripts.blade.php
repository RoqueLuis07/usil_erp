<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['cuenta', 'nombre', 'nivel', 'imputable'],
            page: 50,
            pagination: true
        };
        var cuentas_contablesList = new List('cuentas_contables-list', options);
        cuentas_contablesList.on('updated', function(list) {
