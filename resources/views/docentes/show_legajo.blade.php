@can('ver_legajos_docentes')
    ...
    @section('content')
        ...
        @include('docentes.modals.show-legajo-modals')
                                                ...
                                                <div class="card card-body text-center">
                                                    <div class="mx-auto mb-3">
                                                        ...
                                                        @can('eliminar_legajos_docentes')
                                                            ...
                                                            <form action="{{route('docentes.eliminar_legajo', $legajo->id)}}" method="delete" id="delete-legajo-form-{{$legajo->id}}">
                                                                @csrf
                                                            </form>
                                                        @endcan
                                                    </div>
    ...
    @section('script')
        ...
        @include('docentes.scripts.show-legajo-scripts')
    @endsection
@endcan
