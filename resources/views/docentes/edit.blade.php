@can('editar_docentes')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('docentes.update', $docente->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <select class="selectpicker form-control @error('area_conocimiento') is-invalid @enderror" id="area_conocimiento" name="area_conocimiento" data-live-search="true">
                                                        ...
                                                        @foreach ($areas_conocimientos as $area_conocimiento)
                                                            <option value="{{$area_conocimiento->id}}" @if (old('area_conocimiento') == strval($area_conocimiento->id) || $docente->area_conocimiento_id == strval($area_conocimiento->id)) selected @endif data-subtext="{{ $area_conocimiento->abreviatura }}">{{$area_conocimiento->nombre}}</option>
                                                        @endforeach
                                                    </select>
    ...
    @section('script')
        ...
        @include('docentes.scripts.edit-scripts')
    @endsection
@endcan
