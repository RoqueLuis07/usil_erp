@can('crear_tipos_extensiones_universitarias')
    ...
    @section('content')
        @component('components.breadcrumb')
            @slot('li_1') Tipos de Extensión Universitaria @endslot
            @slot('title') Agregar Tipo de Extensión  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('tipos_extensiones_universitarias.store')}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Nuevo tipo de extensión universitaria</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control text-center @error('maxima_cantidad_horas') is-invalid @enderror" id="maxima_cantidad_horas" name="maxima_cantidad_horas" value="{{old('maxima_cantidad_horas')}}" placeholder="60">
    ...
    @section('script')
        ...
        @include('extensiones_universitarias.tipos.scripts.create-scripts')
    @endsection
@endcan
