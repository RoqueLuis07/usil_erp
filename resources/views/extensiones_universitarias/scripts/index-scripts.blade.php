<script type="module">
    ...
    $('#show-reporte-btn').click(function () {
        ...
        swalWithBootstrapButtons.fire({
            title: '¿Está seguro de generar la visualización del reporte de extensión universitaria?',
            icon: 'question',
            ...
            if (result.isConfirmed) {
                $('#showReporte-form').submit();
            }
        })
    })

    $('#show-reporte-carrera-semestre-btn').click(function () {
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
                confirmButton: 'btn btn-success me-2',
                cancelButton: 'btn btn-light',
        ...
        swalWithBootstrapButtons.fire({
            title: '¿Está seguro de generar la visualización del reporte por carrera y semestre?',
            icon: 'question',
            showCancelButton: true,
            confirmButtonText: 'Sí, generar!',
            cancelButtonText: 'Cancelar',
            ...
            if (result.isConfirmed) {
                $('#showReporteCarreraSemestre-form').submit();
            }
        })
    })
</script>
