@can('editar_usuarios')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('usuarios.update', $usuario->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Escriba un nombre de usuario" value="{{old('name', $usuario->name)}}">
                                    @error('name')
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Escriba un correo electrónico" value="{{old('email', $usuario->email)}}">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select class="selectpicker form-control @error('rol') is-invalid @enderror" id="rol" name="rol">
                                        <option value="" selected disabled>Seleccione un rol...</option>
                                        @foreach ($roles as $rol)
                                            <option value="{{$rol->id}}" @if(old('rol') == strval($rol->id)) selected @elseif ($usuario->role_id == $rol->id) selected @endif>{{$rol->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('rol')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    <label class="form-label" for="password">Contraseña</span></label>
                                ...
                                <div class="col-lg-4">
                                    <label class="form-label" for="password_confirmation">Confirmar Contraseña</span></label>
    ...
    @section('script')
        ...
        @include('usuarios.scripts.edit-scripts')
    @endsection
@endcan
