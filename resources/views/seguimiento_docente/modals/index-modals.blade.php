@foreach ($clases_materias as $clase)
    <!-- destroyModal -->
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="destroy-form-{{$clase->id}}" action="{{route('seguimiento_docente.destroy', $clase->id)}}" method="delete">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                        <h4>¿Está seguro de eliminar la clase y asistencias de la materia {{$clase->materia->nombre_fantasia}} de la fecha {{\Carbon\Carbon::parse($clase->fecha_hora)->format('d/m/Y H:i:s')}}?</h4>
                                    </div>
                                </div>
                                <div class="row">
