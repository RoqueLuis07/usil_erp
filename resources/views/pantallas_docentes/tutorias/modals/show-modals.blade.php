                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="alumno_modal" value="{{$detalle->alumno->primer_apellido}}, {{$detalle->alumno->primer_nombre}}" readonly>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3 text-center">
                                    ...
                                    <input type="text" class="form-control text-center" id="asistencia" @if ($detalle->cantidad_asistencias > 0) value="{{($detalle->cantidad_asistencias / $tutoria->cantidad_clases) * 100}}%" @else value="---" @endif readonly>
                                </div>
                                <div class="col-lg-4 mb-3 text-center">
                                    <label class="form-label" for="asistencia">Puntaje</label>
                                    <input type="text" class="form-control text-center" id="asistencia" @if ($detalle->puntos_obtenidos) value="{{$detalle->puntos_obtenidos}}" @else value="---" @endif readonly>
                                </div>
                                <div class="col-lg-4 mb-3 text-center">
                                    <label class="form-label" for="calificacion">Calificación</label>
                                    <input type="text" class="form-control text-center" id="calificacion" @if ($detalle->calificacion) value="{{$detalle->calificacion}}" @else value="---" @endif readonly>
                                </div>
                            </div>
                            <div class="row">
