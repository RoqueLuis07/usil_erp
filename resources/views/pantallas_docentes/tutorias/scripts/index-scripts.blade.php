<script type="module">
    ...
    $(document).ready(function() {
        var options = {
            valueNames: ['materia', 'modalidad', 'inicio', 'fin'],
            page: 10,
            pagination: true
        };
        tutoriasList = new List('tutorias-list', options);
		...
		cantidad_mostrada(tutoriasList.size());
	});
	...
	function cantidad_mostrada(total_lista) {
	  var total = tutoriasList.size();
      var tamanho_pagina = 50;
      var pagina_actual = tutoriasList.i;
