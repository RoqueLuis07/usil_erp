                    ...
                    <div class="card-body">
                        <div id="puntajes-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap text-center" id="puntajes-list">
                                    ...
                                    <tbody class="list form-check-all">
                                        @forelse ($materias as $materia)
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-sm btn-primary" href="{{route('pantallas_docentes.show_puntajes_alumnos', $materia->id)}}">Ver</a>
                                                </td>
                                            </tr>
                                        @empty
