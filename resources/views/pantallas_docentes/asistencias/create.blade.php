@can('crear_asistencias_docentes_pantalla')
    ...
    @section('title') Cargar Asistencias @endsection
    @section('css')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Cargar asistencias</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
    ...
    @section('script')
        ...
        @include('pantallas_docentes.asistencias.scripts.create-scripts')
    @endsection
@endcan
