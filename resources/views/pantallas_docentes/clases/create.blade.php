@can('crear_clases_docentes_pantalla')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('clases_materias.store')}}" method="post" id="store-form">
                @csrf
                <input type="hidden" name="generado_docente" value="SI">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Nueva clase</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                                                ...
                                                <div class="col-lg-4 mb-3 text-center">
                                                    ...
                                                    <select class="selectpicker form-control @error('modalidad') is-invalid @enderror" id="modalidad" name="modalidad" data-live-search="true">
                                                        ...
                                                        @foreach ($modalidades as $modalidad)
                                                            <option value="{{$modalidad->id}}" @if (old('modalidad') == strval($modalidad->id) || $modalidad_encontrada == strval($modalidad->id)) selected @endif>{{$modalidad->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('modalidad')
                                                        <span class="invalid-feedback" role="alert">
    ...
    @section('script')
        ...
        @include('pantallas_docentes.clases.scripts.create-scripts')
    @endsection
@endcan
