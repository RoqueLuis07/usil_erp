                ...
                <div class="col-lg-12">
                                                                                        ...
                                                                                        <table class="table table-sm table-borderless">
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="text-muted fs-sm">{{$puntaje->puntos_obtenidos}} - Real: {{($puntaje->puntos_obtenidos)}}</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th class="ps-0 fs-md" scope="row">Puntos Posibles:</th>
                                                                                                    <td class="text-muted fs-sm">{{$puntaje->evaluacion->puntos}} - Real: {{($puntaje->evaluacion->puntos)}}</td>
                                                                                                </tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('materias_semestres.index')}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
