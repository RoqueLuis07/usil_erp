@can('ver_bancos')
    ...
    @section('content')
        ...
        @include('bancos.scripts.messages-scripts')
        @include('bancos.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Bancos</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="bancos-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="bancos-list">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ningún banco según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('bancos.scripts.index-scripts')
    @endsection
@endcan
