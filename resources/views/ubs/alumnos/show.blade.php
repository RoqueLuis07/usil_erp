@can('ver_alumnos_ubs')
    @extends('layouts.master')
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="forma_conocimiento" @if ($alumno->forma_conocimiento_id) value="{{$alumno->formaConocimiento->nombre}}" @endif readonly>
                                    </div>
                                    <div class="col-lg-4 mb-3">
                                        <label class="form-label" for="link_crm">Link CRM</label>
                                        <input type="text" class="form-control" id="link_crm" value="{{$alumno->link_crm}}" readonly>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label class="form-label" for="observaciones">Observaciones</label>
                                        <textarea class="form-control" id="observaciones" cols="30" rows="3" readonly>{{$alumno->observaciones}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="tab-pane active show" id="tablistFormacion" role="tabpanel">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 mb-3">
                                                        ...
                                                        <input type="text" class="form-control text-center" id="anho_egreso_educativo" value="{{$alumno->anho_egreso_educativo}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="tab-pane" id="tablistRedesSociales" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-2 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="facebook" value="{{$alumno->facebook}}"readonly>
                                                    </div>
                                                    <div class="col-lg-2 mb-3">
                                                        <label class="form-label" for="twitter">X (Twitter)</label>
                                                        <input type="text" class="form-control" id="twitter" value="{{$alumno->twitter}}"readonly>
                                                    </div>
                                                    <div class="col-lg-2 mb-3">
                                                        <label class="form-label" for="instagram">Instagram</label>
                                                        <input type="text" class="form-control" id="instagram" value="{{$alumno->instagram}}"readonly>
                                                    </div>
                                                    <div class="col-lg-2 mb-3">
                                                        <label class="form-label" for="linkedin">Linkedin</label>
                                                        <input type="text" class="form-control" id="linkedin" value="{{$alumno->linkedin}}"readonly>
                                                    </div>
                                                    <div class="col-lg-2 mb-3">
                                                        <label class="form-label" for="tiktok">TikTok</label>
                                                        <input type="text" class="form-control" id="tiktok" value="{{$alumno->tiktok}}"readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-content">
                                            <div class="tab-pane" id="tablistFamiliar1" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-4 mb-3">
                                                        <label class="form-label" for="nombre_familiar_1">Nombre Completo</label>
                                                        <input type="text" class="form-control" id="nombre_familiar_1" value="{{$nombre_familiar_uno}}" readonly>
                                                    </div>
                                                    <div class="col-lg-2 mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-end mb-3">
                                <a type="button" class="btn btn-danger me-2" href="{{route('alumnos_ubs.index')}}">Volver</a>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        @section('script')
            ...
            @include('ubs.alumnos.scripts.show-scripts')
        @endsection
@endcan
