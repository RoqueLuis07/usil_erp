            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('alumnos_ubs.subir_legajo', $alumno->id)}}" method="post" id="store-alumno-legajo-form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="hstack gap-2 justify-content-center">
                                    <button type="button" class="btn btn-success" id="save-legajo-btn" data-id="{{$alumno->id}}">Subir</button>
