@can('crear_alumnos_ubs')
    ...
    @section('content')
        ...
        @include('ubs.alumnos.modals.create-modals')

        <div class="row">
            <form action="{{route('alumnos_ubs.store')}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <select class="selectpicker form-control @error('forma_conocimiento') is-invalid @enderror" id="forma_conocimiento" name="forma_conocimiento" value="{{old('forma_conocimiento')}}" data-live-search="true">
                                        ...
                                        @foreach ($formas_conocimientos as $forma_conocimiento)
                                            <option value="{{$forma_conocimiento->id}}" @if (old('forma_conocimiento') == strval($forma_conocimiento->id)) selected @endif>{{$forma_conocimiento->nombre}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('link_crm') is-invalid @enderror" id="link_crm" name="link_crm" value="{{old('link_crm')}}">
                                    @error('link_crm')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <textarea class="form-control" id="observaciones @error('observaciones') is-invalid @enderror" name="observaciones" cols="30" rows="3">{{old('observaciones')}}</textarea>
                                    @error('observaciones')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                        ...
                                        <div class="tab-pane" id="tablistFormacion" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" class="form-control text-center @error('anho_egreso_educativo') is-invalid @enderror" id="anho_egreso_educativo" name="anho_egreso_educativo" value="{{old('anho_egreso_educativo')}}" placeholder="2020">
    ...
    @section('script')
        ...
        @include('ubs.alumnos.scripts.create-scripts')
        @include('ubs.alumnos.scripts.create-clientes-scripts')
    @endsection
@endcan
