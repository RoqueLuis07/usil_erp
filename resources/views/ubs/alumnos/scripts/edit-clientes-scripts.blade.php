<script type="module">
            ...
            var filaAdd = `<div class="mb-2 fila" id="fila-${nro_nueva_fila}">
                                <div class="row d-flex flex-wrap justify-content-center">
                                    <div class="col-lg-2 mb-2 text-center" id="div-cliente-${nro_nueva_fila}">
                                        ...
                                        <span class="invalid-feedback error-cliente-${nro_nueva_fila}" role="alert">
                                    ...
                                    <div class="col-lg-2 mb-2 me-3 text-center" id="div-razon_social-${nro_nueva_fila}">
                                        ...
                                        <span class="invalid-feedback error-razon_social-${nro_nueva_fila}" role="alert">
                                    ...
                                    <div class="col-lg-2 mb-2 me-3 text-center" id="div-numero_documento-${nro_nueva_fila}">
                                        ...
                                        <span class="invalid-feedback error-numero_documento-${nro_nueva_fila}" role="alert">
                                    ...
                                    <div class="col-lg-1 mb-2 me-3 text-center" id="div-es_principal-${nro_nueva_fila}">
                                        ...
                                        <div class="btn-group @error('clientes.${nro_nueva_fila}.es_principal') is-invalid @enderror" role="group">
                                            <input type="radio" class="btn-check es_principal1 es_principal1-${nro_nueva_fila} es_principal1" id="clientes[${nro_nueva_fila}][es_principal1]" name="clientes[${nro_nueva_fila}][es_principal]" value="false" @if (old('clientes[${nro_nueva_fila}][es_principal]') == 'false') checked @endif data-id="${nro_nueva_fila}">
                                            <label class="btn btn-outline-danger" for="clientes[${nro_nueva_fila}][es_principal1]">No</label>
                                            <input type="radio" class="btn-check es_principal2 es_principal2-${nro_nueva_fila} es_principal2" id="clientes[${nro_nueva_fila}][es_principal2]" name="clientes[${nro_nueva_fila}][es_principal]" value="true" @if (old('clientes[${nro_nueva_fila}][es_principal]') == 'true') checked @endif data-id="${nro_nueva_fila}">
                                            <label class="btn btn-outline-success" for="clientes[${nro_nueva_fila}][es_principal2]">Sí</label>
                                        </div>
                                        <input type="hidden" class="es_principal-${nro_nueva_fila}" value="{{old('clientes.${nro_nueva_fila}.es_principal')}}">
                                        <span class="invalid-feedback error-es_principal-${nro_nueva_fila}" role="alert">
    ...
    function insertarLabels(primera_fila) {
        if ($('.label-cliente').text() == '') {
            $('<label class="form-label label-cliente">Cliente</label>').insertBefore('#cliente-' + primera_fila);
        }
        if ($('.label-razon_social').text() == '') {
            $('<label class="form-label label-razon_social">Razón Social</label>').insertBefore('.razon_social-' + primera_fila);
        }
        if ($('.label-numero_documento').text() == '') {
            $('<label class="form-label label-numero_documento">N° de Documento</label>').insertBefore('.numero_documento-' + primera_fila);
        }
        if ($('.label-es_principal').text() == '') {
            $('.div-label-es_principal-' + primera_fila).html('<label class="form-label label-es_principal">Es Principal ?</label>')
        }
