@can('ver_legajos_alumnos_ubs')
    ...
    @section('content')
        ...
        @include('ubs.alumnos.modals.show-legajo-modals')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap">
                        <div class="col-lg-6">
                            <h4 class="card-title mb-0">Visualizar legajo del alumno</h4>
                        </div>
                        <div class="col-lg-6 text-end" id="div-subir" style="margin-bottom: -5em">
                            @can('subir_legajos_alumnos_ubs')
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-lg-2 col-xxl-2">
                                                <div class="card card-body text-center">
                                                    <div class="mx-auto mb-3">
                                                        ...
                                                        @endif
                                                        @can('eliminar_legajos_alumnos_ubs')
                                                            ...
                                                            <form action="{{route('alumnos_ubs.eliminar_legajo', $legajo->id)}}" method="delete" id="delete-legajo-form-{{$legajo->id}}">
                                                                @csrf
                                                            </form>
                                                        @endcan
                                                    </div>
                                            ...
                                            @empty
                                                <div class="col-lg-12 mb-3 text-center">
                                                    <p>El alumno no cuenta con ningún archivo subido en su legajo cargado.</p>
                                                </div>
                                            @endforelse
                                        </div>
                                    </div>
    ...
    @section('script')
        ...
        @include('ubs.alumnos.scripts.show-legajo-scripts')
    @endsection
@endcan
