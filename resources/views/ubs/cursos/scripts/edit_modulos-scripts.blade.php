<script type="module">
    ...
    $('#update-btn').click(function () {
        ...
        swalWithBootstrapButtons.fire({
            title: '¿Está seguro de guardar los módulos del curso ' + nombre + '?',
            icon: 'question',
            showCancelButton: true,
    ...
    $(document).on('click', '.btn-add', function () {
        ...
        if ($('.modulo-' + nro_ultima_fila + ' option:selected').val() && $('.docente-' + nro_ultima_fila + ' option:selected').val()) {
            ...
            message('Debe seleccionar un módulo antes de insertar la siguiente línea.')
        }
    })
