@can('crear_cursos_ubs')
    ...
    @section('title') Agregar Curso @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Agregar Curso  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('cursos.store')}}" method="post" id="store-form" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Nuevo curso</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('llamado') is-invalid @enderror" id="llamado" name="llamado" placeholder="Escriba el número de llamado" value="{{old('llamado')}}">
                                                @error('llamado')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{$message}}</strong>
                                                    </span>
                                            ...
                                            <div class="col-lg-2 mb-3 text-center">
                                                ...
                                                <div class="text-center">
                                                    <div class="btn-group @error('evaluacion') is-invalid @enderror" role="group">
                                                        <input type="radio" class="btn-check" id="evaluacion1" name="evaluacion" value="false" @if (old('evaluacion') == 'false' || old('evaluacion') == null) checked @endif>
                                                        <label class="btn btn-outline-danger" for="evaluacion1">No</label>
                                                        <input type="radio" class="btn-check" id="evaluacion2" name="evaluacion" value="true" @if (old('evaluacion') == 'true') checked @endif>
    ...
    @section('script')
        ...
        @include('ubs.cursos.scripts.create-scripts')
    @endsection
@endcan
