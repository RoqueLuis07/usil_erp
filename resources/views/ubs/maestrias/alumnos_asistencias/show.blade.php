@can('ver_asistencias_maestrias_ubs')
    ...
    @section('content')
        ...
        @include('ubs.maestrias.alumnos_asistencias.modals.show-modals')
                                    ...
                                    <div class="row">
                                                                        ...
                                                                        <table class="table align-middle table-nowrap text-center" id="asistencias-list">
                                                                            ...
                                                                            <tbody class="list form-check-all">
                                                                                @foreach ($asistencias_generales as $alumno => $asistencias)
                                                                                    <tr>
                                                                                        <td class="alumno">{{$asistencias->first()->alumno->primer_nombre}} {{$asistencias->first()->alumno->primer_apellido}}</td>
                                                                                        <td class="numero_documento">{{$asistencias->first()->alumno->numero_documento}}</td>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    @if ($maestria->asistencias->count() > 0)
                                                        <div class="mb-2">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <button type="button" class="btn
                                                                                                                                ...
                                                                                                                                @endif
                                                                                                                                @if (!Auth::user()->can('editar_asistencias_maestrias_ubs'))
                                                                                                                                    disabled
                                                                                                                                @endif>
                                                    ...
                                                    @else
                                                        <div class="col-lg-12 text-center">
                                                            <h6>La maestría no cuenta con asistencias cargadas actualmente.</h6>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
    ...
    @section('script')
        ...
        @include('ubs.maestrias.alumnos_asistencias.scripts.show-scripts')
    @endsection
@endcan
