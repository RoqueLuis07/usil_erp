...
<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['numero_documento', 'alumno', 'evaluacion_continua', 'examen_final', 'calificacion'],
            page: 10,
            pagination: true
        };
        var lista_alumnosList = new List('lista_alumnos-list', options);
        lista_alumnosList.on('updated', function(list) {
    ...
    function saveActa(id, url) {
        ...
        $.ajax({
            ...
            var url = "{{route('actas_evaluaciones_ubs.show', ":id")}}"
