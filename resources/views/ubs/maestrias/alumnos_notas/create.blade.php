@can('crear_notas_maestrias_ubs')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('alumnos_notas_ubs.store', ['curso' => $maestria->curso_id, 'modulo' => $maestria->modulo_id, 'evaluacion' => $evaluacion->id])}}" method="post" id="store-form">
                @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 mb-3">
                                    <label class="form-label" for="curso">Maestría</label>
                                    <input type="text" class="form-control" id="curso" value="{{$maestria->curso->nombre_fantasia}}" readonly>
                                </div>
                                <div class="col-lg-3 mb-3">
                                    <label class="form-label" for="modulo">Módulo</label>
                                    <input type="text" class="form-control" id="modulo" value="{{$maestria->modulo->nombre_fantasia}}" readonly>
                                </div>
                                <div class="col-lg-3 mb-3">
                                    <label class="form-label" for="docente">Docente</label>
                                    <input type="text" class="form-control" id="docente" value="{{$maestria->docente->primer_nombre}} {{$maestria->docente->primer_apellido}}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3">
                                    <label class="form-label" for="fecha">Evaluación</label>
                                    <input type="text" class="form-control" id="evaluacion" value="{{$evaluacion->nombre}}" readonly>
                                ...
                                <div class="card-body">
                                        @foreach ($alumnos as $key => $alumno)
                                            <div class="row d-flex flex-wrap justify-content-center">
                                                <div class="col-8 col-lg-2 mb-3 text-center">
                                                ...
                                                <div class="col-lg-1 mb-3 text-center d-none d-lg-block">
                                                ...
                                                @if ($evaluacion->id != 1)
                                                    <div class="col-4 col-lg-1 mb-3 text-center">
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <input type="hidden" id="asistencia-{{$key}}" name="detalles[{{$key}}][estado]" value="AUSENTE">
                                                        </div>
                                                    </div>
                                                @else
                                                    <input type="hidden" name="detalles[{{$key}}][estado]" value="AUSENTE">
                                                @endif
                                                <div class="col-lg-1 mb-3 text-center d-none d-lg-block">
                                                    @if ($key == 0) <label class="form-label" for="puntos">Puntos</label> @endif
                                                    <input type="text" class="form-control text-center puntos puntos-{{$key}} @error('detalles.' . $key . '.puntos') is-invalid @enderror" placeholder="0 - @if ($evaluacion->id == 1) 60 @else 40 @endif" data-id="{{$key}}" @if ($evaluacion->id != 1) disabled @endif>
                                                    <input type="hidden" id="puntos-{{$key}}" name="detalles[{{$key}}][puntos]">
    ...
    @section('script')
        ...
        @include('ubs.maestrias.alumnos_notas.scripts.create-scripts')
    @endsection
@endcan
