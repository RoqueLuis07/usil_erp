@can('editar_requerimientos_extensiones_ubs')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('requerimientos_extensiones_universitarias_ubs.store')}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <input type="text" class="form-control text-center @error('actividades_requeridas') is-invalid @enderror" id="actividades_requeridas" name="actividades_requeridas" value="{{old('actividades_requeridas')}}" placeholder="1">
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control text-center @error('horas_requeridas') is-invalid @enderror" id="horas_requeridas" name="horas_requeridas" value="{{old('horas_requeridas')}}" placeholder="40">
