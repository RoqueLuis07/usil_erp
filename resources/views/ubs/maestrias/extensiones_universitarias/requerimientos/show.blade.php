@can('ver_requerimientos_extensiones_ubs')
    ...
    @section('content')
        ...
        @include('ubs.maestrias.extensiones_universitarias.requerimientos.scripts.messages-scripts')
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            ...
                            @can('editar_requerimientos_extensiones_ubs')
                                <a type="button" class="btn btn-warning" href="{{route('requerimientos_extensiones_universitarias_ubs.edit', $requerimiento->id)}}">Editar</a>
                            @endcan
                        </div>
                    </div>
                </div>
    ...
    @section('script')
        ...
        @include('ubs.maestrias.extensiones_universitarias.requerimientos.scripts.show-scripts')
    @endsection
@endcan
