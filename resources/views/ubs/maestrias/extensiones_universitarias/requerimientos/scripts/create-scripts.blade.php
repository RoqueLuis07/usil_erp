<script type="module">
    ...
    $('#cancel-btn').click(function () {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = '{{route('requerimientos_extensiones_universitarias_ubs.show')}}';
            }
        })
    });
    ...
    $('#save-btn').click(function () {
        ...
        swalWithBootstrapButtons.fire({
            title: '¿Está seguro de guardar los requerimientos de las extensiones universitarias?',
            icon: 'question',
            showCancelButton: true,
