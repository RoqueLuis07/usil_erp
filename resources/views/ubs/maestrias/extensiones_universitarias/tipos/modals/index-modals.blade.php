                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="unactivate-form-{{$tipo_extension->id}}" action="{{route('tipos_extensiones_universitarias_ubs.unactivate', $tipo_extension->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="activate-form-{{$tipo_extension->id}}" action="{{route('tipos_extensiones_universitarias_ubs.activate', $tipo_extension->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="destroy-form-{{$tipo_extension->id}}" action="{{route('tipos_extensiones_universitarias_ubs.destroy', $tipo_extension->id)}}" method="delete">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
