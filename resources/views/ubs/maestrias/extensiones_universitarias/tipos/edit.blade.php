@can('editar_tipos_extensiones_ubs')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('tipos_extensiones_universitarias_ubs.update', $tipo_extension->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
    ...
    @section('script')
        ...
        @include('ubs.maestrias.extensiones_universitarias.tipos.scripts.edit-scripts')
    @endsection
@endcan
