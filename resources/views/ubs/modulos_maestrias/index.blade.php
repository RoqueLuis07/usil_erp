@can('ver_modulos_maestrias_ubs')
    ...
    @section('content')
        ...
        @include('ubs.modulos_maestrias.scripts.messages-scripts')
        @include('ubs.modulos_maestrias.modals.index-modals')
                    ...
                    <div class="card-body">
                        <div id="modulos-list">
                            <div class="row g-4 mb-3">
                                <div class="col-lg-8">
                                    @can('crear modulos_maestrias_ubs')
    ...
    @section('script')
        ...
        @include('ubs.modulos_maestrias.scripts.index-scripts')
    @endsection
@endcan
