@can('crear_borradores_tesis_ubs')
    ...
    @section('title') Generar Borrador de Tesis @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Generar Borrador de Tesis @endslot
        @endcomponent

        @include('ubs.tesis.borradores.scripts.messages-scripts')

        <div class="row">
            <form action="{{route('tesis_ubs.store_borrador', $tesis->id)}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap">
                            <div class="col-lg-6">
                                <h4 class="card-title mb-0">Generar borrador de tesis</h4>
                            </div>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
    ...
    @section('script')
        ...
        @include('ubs.tesis.borradores.scripts.create-scripts')
    @endsection
@endcan
