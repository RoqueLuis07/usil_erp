            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-entrega-form" action="{{route('tesis_ubs.save_entrega_anteproyecto', $anteproyecto->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
        ...
        <div class="modal fade flip" id="addCorreccionModal" tabindex="-1" aria-labelledby="addCorreccionModal" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-correccion-form" action="{{route('tesis_ubs.save_correccion_anteproyecto', $anteproyecto->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 mt-3" id="div-archivo">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('tesis_ubs.delete_entrega_anteproyecto', $entrega->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                        @php
