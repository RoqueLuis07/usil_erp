<script type="module">
    ...
    function saveEntrega(id) {
        ...
        var url = "{{route('tesis_ubs.save_entrega_anteproyecto', ":id")}}"
        ...
        $.ajax({
            ...
            var url = "{{route('tesis_ubs.show_entregas_anteproyecto', ":id")}}";
            url = url.replace(':id', id);
    ...
    function saveCorreccion(id) {
        ...
        var url = "{{route('tesis_ubs.save_correccion_anteproyecto', ":id")}}"
        url = url.replace(':id', id);
        $('#add-correccion-form').find('.is-invalid').removeClass('is-invalid');
        $('#add-correccion-form').find('.invalid-feedback').remove();
        var type = 'success';
