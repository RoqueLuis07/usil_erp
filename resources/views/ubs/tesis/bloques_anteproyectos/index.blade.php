@can('ver_bloques_anteproyectos_tesis_ubs')
    ...
    @section('title') Bloques de Anteproyectos @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Bloques de Anteproyectos @endslot
        @endcomponent

        @include('ubs.tesis.bloques_anteproyectos.scripts.messages-scripts')
        @include('ubs.tesis.bloques_anteproyectos.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Bloques de Anteproyectos</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="bloques-list">
    ...
    @section('script')
        ...
        @include('ubs.tesis.bloques_anteproyectos.scripts.index-scripts')
    @endsection
@endcan
