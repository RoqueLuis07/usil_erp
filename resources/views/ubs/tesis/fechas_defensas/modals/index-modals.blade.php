                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="destroy-form-{{$fecha->id}}" action="{{route('tesis_parametros_ubs.fechas_defensas_destroy', $fecha->id)}}" method="delete">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                        <h4>¿Está seguro de eliminar la fecha de defensa {{\Carbon\Carbon::parse($fecha->fecha)->format('d/m/Y H:i')}}?</h4>
                                    </div>
                                </div>
                                <div class="row">
