@can('editar_docentes_ubs')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Editar Docente  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('docentes_ubs.update', $docente->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Actualizar docente</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <select class="selectpicker form-control @error('sexo') is-invalid @enderror" id="sexo" name="sexo">
                                        ...
                                        @foreach ($sexos as $sexo)
                                            <option value="{{$sexo->id}}" @if (old('sexo') == strval($sexo->id) || $docente->sexo_id == strval($sexo->id)) selected @endif>{{$sexo->nombre}}</option>
                                        @endforeach
                                    </select>
                                    @error('sexo')
                                        <span class="invalid-feedback" role="alert" id="error-select">
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <div class="form-icon right">
                                        <input type="text" class="flatpickr form-control form-control-icon @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{old('fecha_nacimiento', $docente->fecha_nacimiento)}}" placeholder="Seleccionar...">
                            ...
                            <div class="row">
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{old('telefono', $docente->telefono)}}" placeholder="Escriba el N° de línea baja">
                                    @error('telefono')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('celular') is-invalid @enderror" id="celular" name="celular" value="{{old('celular', $docente->celular)}}" placeholder="Escriba el N° de celular">
                                    @error('celular')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <select class="selectpicker form-control @error('nivel_academico') is-invalid @enderror" id="nivel_academico" name="nivel_academico" data-live-search="true">
                                                        ...
                                                        @foreach ($niveles_academicos as $nivel_academico)
                                                            <option value="{{$nivel_academico->id}}" @if (old('nivel_academico') == strval($nivel_academico->id) || $docente->nivel_academico_id == strval($nivel_academico->id)) selected @endif>{{$nivel_academico->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <div class="btn-group @error('capacitacion_didactica') is-invalid @enderror" role="group">
                                                        <input type="radio" class="btn-check" id="capacitacion_didactica1" name="capacitacion_didactica" value="false" @if (old('capacitacion_didactica') == 'false' || $docente->capacitacion_didactica == false) checked @endif>
                                                        <label class="btn btn-outline-danger" for="capacitacion_didactica1">No</label>
                                                        <input type="radio" class="btn-check" id="capacitacion_didactica2" name="capacitacion_didactica" value="true" @if (old('capacitacion_didactica') == 'true' || $docente->capacitacion_didactica == true) checked @endif>
                                        ...
                                        <div class="tab-pane" id="tablistLaboral" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    @if ($docente->dato_laboral_id)
                                                        <input type="text" class="form-control @error('empresa') is-invalid @enderror" id="empresa" name="empresa" value="{{old('empresa', $docente->datoLaboral->empresa)}}" placeholder="Escriba el nombre de la empresa">
                                                    @else
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    @if ($docente->dato_laboral_id)
                                                        <input type="text" class="form-control @error('cargo') is-invalid @enderror" id="cargo" name="cargo" value="{{old('cargo', $docente->datoLaboral->cargo)}}" placeholder="Escriba el cargo que ocupa">
                                                    @else
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    @if ($docente->dato_laboral_id)
                                                        <input type="text" class="form-control @error('email_laboral') is-invalid @enderror" id="email_laboral" name="email_laboral" value="{{old('email_laboral', $docente->datoLaboral->email)}}" placeholder="Escriba el correo electrónico laboral">
                                                    @else
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    @if ($docente->dato_laboral_id)
                                                        <input type="text" class="form-control @error('telefono_laboral') is-invalid @enderror" id="telefono_laboral" name="telefono_laboral" value="{{old('telefono_laboral', $docente->datoLaboral->telefono)}}" placeholder="Escriba el N° de la empresa">
                                                    @else
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    @if ($docente->dato_laboral_id)
                                                        <input type="text" class="form-control @error('celular_laboral') is-invalid @enderror" id="celular_laboral" name="celular_laboral" value="{{old('celular_laboral', $docente->datoLaboral->celular)}}" placeholder="Escriba el N° de celular">
                                                    @else
                                        ...
                                        <div class="tab-pane" id="tablistRedesSociales" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('facebook') is-invalid @enderror" id="facebook" name="facebook" value="{{old('facebook', $docente->facebook)}}">
                                                    @error('facebook')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('twitter') is-invalid @enderror" id="twitter" name="twitter" value="{{old('twitter', $docente->twitter)}}">
                                                    @error('twitter')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('instagram') is-invalid @enderror" id="instagram" name="instagram" value="{{old('instagram', $docente->instagram)}}">
                                                    @error('instagram')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('linkedin') is-invalid @enderror" id="linkedin" name="linkedin" value="{{old('linkedin', $docente->linkedin)}}">
                                                    @error('linkedin')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('tiktok') is-invalid @enderror" id="tiktok" name="tiktok" value="{{old('tiktok', $docente->tiktok)}}">
                                                    @error('tiktok')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                        ...
                                        <div class="tab-pane" id="tablistFacturacion" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('razon_social') is-invalid @enderror" id="razon_social" name="razon_social" value="{{old('razon_social', $docente->razon_social)}}">
                                                    @error('razon_social')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('ruc') is-invalid @enderror" id="ruc" name="ruc" value="{{old('ruc', $docente->ruc)}}">
                                                    @error('ruc')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 mb-3">
                                                    ...
                                                    <select class="form-control selectpicker @error('banco') is-invalid @enderror" id="banco" name="banco" data-live-search="true">
                                                        ...
                                                        @foreach ($bancos as $banco)
                                                            <option value="{{$banco->id}}" @if (old('banco') == strval($banco->id) || $docente->banco_id == strval($banco->id)) selected @endif>{{$banco->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('banco')
                                                        <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <select class="form-control selectpicker @error('tipo_cuenta_bancaria') is-invalid @enderror" id="tipo_cuenta_bancaria" name="tipo_cuenta_bancaria" data-live-search="true">
                                                        <option value="" selected disabled>Seleccionar...</option>
                                                        <option value="CA" @if (old('tipo_cuenta_bancaria') == 'CA' || $docente->tipo_cuenta_bancaria == 'CA') selected @endif>Caja de Ahorro</option>
                                                        <option value="CC" @if (old('tipo_cuenta_bancaria') == 'CC' || $docente->tipo_cuenta_bancaria == 'CC') selected @endif>Cuenta Corriente</option>
                                                    </select>
                                                ...
                                                <div class="col-lg-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('numero_cuenta_bancaria') is-invalid @enderror" id="numero_cuenta_bancaria" name="numero_cuenta_bancaria" value="{{old('numero_cuenta_bancaria', $docente->numero_cuenta_bancaria)}}">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            ...
                            <button type="button" class="btn btn-success" id="update-btn" data-id="{{$docente->id}}">Actualizar</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @section('script')
        ...
        @include('ubs.docentes.scripts.edit-scripts')
    @endsection
@endcan
