<script type="module">
    ...
    var numero = $('#telefono-celular').val();

    $(document).ready(function () {
        if ($('#telefono-celular').val().length == 11) {
            $('#linea_baja').prop('checked', true);
        ...
        } else if ($('#telefono-celular').val().length > 11){
            $('#celular').prop('checked', true);
            $('#telefono-linea_baja').prop('hidden', true);
    ...
    $('#linea_baja').on('change', function () {
        if ($(this).prop('checked')) {
            if (numero.length == 11) {
                $('#telefono-linea-baja').val(numero);
            }
            $('#telefono-celular').val('');
            $('#telefono-celular').prop('hidden', true);
            $('#telefono-linea-baja').prop('hidden', false);
