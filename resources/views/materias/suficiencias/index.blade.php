@can('ver_materias_suficiencias')
    ...
    @section('title') Materias de Suficiencia @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Materias de Suficiencia @endslot
        @endcomponent

        @include('materias.suficiencias.scripts.messages-scripts')
        @include('materias.suficiencias.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Materias de Suficiencia</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
    ...
    @section('script')
        ...
        @include('materias.suficiencias.scripts.index-scripts')
    @endsection
@endcan
