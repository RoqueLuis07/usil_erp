@can('ver_materias')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Materias @endslot
        @endcomponent

        @include('materias.scripts.messages-scripts')
        @include('materias.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Materias</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
    ...
    @section('script')
        ...
        @include('materias.scripts.index-scripts')
    @endsection
@endcan
