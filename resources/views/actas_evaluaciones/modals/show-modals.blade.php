    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('actas_evaluaciones.subir_acta', $acta_evaluacion->id)}}" method="post" id="store-acta-form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="hstack gap-2 justify-content-center">
                            <button type="button" class="btn btn-success" id="save-acta-btn" data-id="{{$acta_evaluacion->id}}" data-url="{{route('actas_evaluaciones.subir_acta', $acta_evaluacion->id)}}">Subir</button>
