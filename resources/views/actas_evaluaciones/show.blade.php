@can('ver_actas')
    ...
    @section('content')
        ...
        @include('actas_evaluaciones.modals.show-modals')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap">
                            <div class="col-lg-6">
                                <h4 class="card-title mb-0">Visualizar acta de evaluación</h4>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <input type="text" class="form-control text-center" id="numero_acta" value="{{$acta_evaluacion->numero_acta}}" readonly>
                                </div>
                                <div class="col-lg-1 mb-3">
                                    <label class="form-label" for="semestre">Período</label>
                                    <input type="text" class="form-control text-center" id="semestre" value="{{$acta_evaluacion->semestre->nombre}}" readonly>
                                </div>
                                <div class="col-lg-1 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="materia" value="{{$acta_evaluacion->materia->nombre_fantasia}}" readonly>
                                </div>
                                <div class="col-lg-1 mb-3">
                                    <label class="form-label" for="materia_semestre">Semestre</label>
                                    <input type="text" class="form-control text-center" id="materia_semestre" value="{{$acta_evaluacion->materia_semestre}}" readonly>
                                </div>
                                <div class="col-lg-2 mb-3">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="carrera" value="{{$acta_evaluacion->carrera->nombre_fantasia}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('actas_evaluaciones.index')}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
            @can('eliminar_adjunto_actas')
                <form action="{{route('actas_evaluaciones.eliminar_acta', $acta_evaluacion->id)}}" method="delete" id="eliminar-acta-form">
                    @csrf
                </form>
            @endcan
        </div>
    ...
    @section('script')
        ...
        @include('actas_evaluaciones.scripts.show-scripts')
    @endsection
@endcan
