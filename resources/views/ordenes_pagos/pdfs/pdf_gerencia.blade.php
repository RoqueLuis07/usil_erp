...
@section('css')
    <style>
        ...
        .tabla-cuenta-contable th {
            text-align: center;
            background-color: lightgray;
        }
        .tabla-cuenta-contable td {
            text-align: left;
        }
        .tabla-firmas {
            width: 100%;
...
@section('pdf_content')
    ...
    <div class="tabla">
        ...
        <table class="tabla-cuenta-contable">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    <td>{{ $orden_pago->cuentaContable->cuenta }}</td>
                    <td>{{ $orden_pago->cuentaContable->nombre }}</td>
                    <td>{{ $orden_pago->concepto }}</td>
                    <td>{{ $orden_pago->moneda->nombre }}</td>
                    <td style="text-align: center!important">{{ number_format($orden_pago->monto_total, $decimales, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
    </div>
