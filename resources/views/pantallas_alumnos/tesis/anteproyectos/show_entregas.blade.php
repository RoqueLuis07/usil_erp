@can('ver_entregas_anteproyectos_tesis_alumnos_pantalla')
    ...
    @section('title') Entregas de Anteproyecto @endsection
    @section('css')
    ...
    @section('content')
        ...
        @include('pantallas_alumnos.tesis.anteproyectos.modals.show_entregas-modals')
                ...
                <div class="col-lg-12">
                                ...
                                @forelse ($anteproyecto->entregas as $entrega)
                                    <a class="list-group-item list-group-action">
                                        <div class="float-end">
                                            ...
                                            @if ($entrega->entrega == true && $anteproyecto->estado != 'AP')
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('pantallas_alumnos.show_anteproyectos_tesis', $anteproyecto->inscripcion_id)}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @section('script')
        ...
        @include('pantallas_alumnos.tesis.anteproyectos.scripts.show_entregas-scripts')
    @endsection
@endcan
