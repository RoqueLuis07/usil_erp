                        ...
                        @if ($entrega->url_archivo)
                            ...
                            <div class="row text-center">
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div>
                                        @php
                                            $nombre = 'entrega_' . $entrega->numero . '_anteproyecto_bloque_' . $entrega->anteproyecto->bloque->numero;
