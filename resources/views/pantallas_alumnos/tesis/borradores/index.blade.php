@can('ver_borradores_tesis_alumnos_pantalla')
    ...
    @section('title') Borradores de T.F.G. @endsection
    @section('css')
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Borradores de Trabajos Finales de Grado</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="temas-list">
                                    ...
                                    <tbody class="list form-check-all">
                                        @forelse ($temas as $tema)
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-sm btn-primary" href="{{route('pantallas_alumnos.show_borradores_tesis', $tema->id)}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ver"><i class="ri-eye-fill"></i></a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="6">No cuenta con borradores aprobados.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
    ...
    @section('script')
        ...
        @include('pantallas_alumnos.tesis.borradores.scripts.index-scripts')
    @endsection
@endcan
