@can('ver_anteproyectos_tesis_alumnos_pantalla')
    ...
    @section('title') Ver Anteproyecto de T.F.G. @endsection
    @section('css')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap">
                            <div class="col-lg-6">
                                <h4 class="card-title mb-0">Anteproyecto de Trabajo Final de Grado</h4>
                            </div>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                                        ...
                                        <table class="table align-middle table-nowrap text-center">
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($tema->anteproyectos as $anteproyecto)
                                                    <tr>
                                                        <td style="text-align: left!important">BLOQUE {{$anteproyecto->bloque->numero}} | {{$anteproyecto->bloque->nombre}}</td>
                                                        ...
                                                        <td>
                                                            @if ($anteproyecto->fecha_aprobado_tutor)
                                                                {{\Carbon\Carbon::parse($anteproyecto->fecha_aprobado_tutor)->format('d/m/Y')}}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @can('ver_entregas_anteproyectos_tesis_alumnos_pantalla')
                                                                <a type="button" class="btn btn-sm btn-primary" href="{{route('pantallas_alumnos.show_entregas_anteproyectos_tesis', $anteproyecto->id)}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ver Entregas"><i class="ri-eye-fill"></i></a>
                                                            @endcan
                                                        </td>
                                                    </tr>
                                                @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('pantallas_alumnos.anteproyectos_tesis', Auth::id())}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @section('script')
        ...
        @include('pantallas_alumnos.tesis.anteproyectos.scripts.show-scripts')
    @endsection
@endcan
