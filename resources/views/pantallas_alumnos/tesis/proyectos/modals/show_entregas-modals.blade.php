...
@foreach ($proyecto->entregas as $entrega)
    ...
    <div class="modal fade flip" id="entregaModal-{{$entrega->id}}" tabindex="-1" aria-labelledby="entregaModal-{{$entrega->id}}" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h4 class="modal-title">Detalle de @if ($entrega->entrega == false) Corección/Comentario @else Entrega @endif</h4>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="row">
                        ...
                        @if ($entrega->url_archivo)
                            ...
                            <div class="row text-center">
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div>
                                        @php
                                            $nombre = 'entrega_' . $entrega->numero . '_proyecto_bloque_' . $entrega->proyecto->bloque->numero;
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('proyectos_tesis.delete_entrega', $entrega->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                        <h4>¿Está seguro de eliminar la entrega?</h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="hstack gap-2 justify-content-center">
