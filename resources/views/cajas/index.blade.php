@can('ver_cajas')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Cajas @endslot
        @endcomponent

        @include('cajas.scripts.messages-scripts')
        @include('cajas.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Cajas</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="cajas-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="cajas-list">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="efectivo">Efectivo</th>
                                            <th class="sort" data-sort="cheque">Cheques</th>
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ninguna caja según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('cajas.scripts.index-scripts')
    @endsection
@endcan
