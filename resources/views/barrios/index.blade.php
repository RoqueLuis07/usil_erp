@can('ver_barrios')
    ...
    @section('title') Barrios @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Barrios @endslot
        @endcomponent

        @include('barrios.scripts.messages-scripts')
        @include('barrios.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Barrios</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="barrios-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="barrios-list">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ningún barrio según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('barrios.scripts.index-scripts')
    @endsection
@endcan
