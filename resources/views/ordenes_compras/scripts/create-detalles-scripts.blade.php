<script type="module">
            ...
            var filaAdd = `<div class="mb-2 fila" id="fila-${nro_nueva_fila}">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 mb-2 text-center" id="div-subtotal-${nro_nueva_fila}">
                                        <input type="text" class="form-control text-center subtotal-${nro_nueva_fila} subtotal @error('detalles.${nro_nueva_fila}.subtotal') is-invalid @enderror" id="detalles[${nro_nueva_fila}][subtotal]" data-id="${nro_nueva_fila}" placeholder="0" readonly>
    ...
    function insertarLabels(primera_fila) {
        ...
        if ($('.label-descripcion').text() == '') {
            $('<label class="form-label label-descripcion">Descripcion</label>').insertBefore('.descripcion-' + primera_fila);
        }
