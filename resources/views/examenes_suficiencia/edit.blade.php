@can('editar_examenes_suficiencia')
    ...
    @section('title') Editar Examen de Suficiencia @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Editar Examen de Suficiencia  @endslot
        @endcomponent

        @include('examenes_suficiencia.scripts.messages-scripts')

        <div class="row">
            <form action="{{route('examenes_suficiencia.update', $examen->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap">
                            <div class="col-lg-8">
                                <h4 class="card-title mb-0">Actualizar examen de suficiencia</h4>
                            </div>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mb-3 text-center">
                                    ...
                                    <select class="selectpicker form-control @error('docente') is-invalid @enderror" id="docente" name="docente" data-live-search="true">
                                        ...
                                        @foreach ($docentes as $docente)
                                            <option value="{{$docente->id}}" @if (old('docente') == strval($docente->id) || $examen->docente_id == strval($docente->id)) selected @endif data-subtext="{{$docente->numero_documento}}">{{$docente->primer_nombre}} {{$docente->primer_apellido}}</option>
                                        @endforeach
                                    </select>
                                    @error('docente')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-1 mb-3 text-center">
                                    ...
                                    <input type="text" class="form-control text-center" id="docente_documento" name="docente_documento" value="{{old('docente_documento', $examen->docente->numero_documento)}}" readonly>
                                </div>
                                <div class="col-lg-2 mb-3 text-center">
                                    ...
                                    <select class="selectpicker form-control @error('modalidad') is-invalid @enderror" id="modalidad" name="modalidad" data-live-search="true">
                                        ...
                                        @foreach ($modalidades as $modalidad)
                                            <option value="{{$modalidad->id}}" @if (old('modalidad') == strval($modalidad->id) || $examen->modalidad_id == strval($modalidad->id)) selected @endif data-subtext="{{$modalidad->numero_documento}}">{{$modalidad->nombre}}</option>
                                        @endforeach
                                    </select>
                                    @error('modalidad')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-2 mb-3 text-center">
                                    ...
                                    <div class="form-icon right">
                                        <input type="text" class="flatpickr form-control form-control-icon text-center @error('fecha_examen') is-invalid @enderror" id="fecha_examen" name="fecha_examen" value="{{old('fecha_examen', $examen->fecha_examen)}}" placeholder="Seleccionar...">
                                ...
                                <div class="col-lg-1 mb-3 text-center">
                                    ...
                                    <input type="text" class="form-control text-center @error('aula_examen') is-invalid @enderror" id="aula_examen" name="aula_examen" value="{{old('aula_examen', $examen->aula_examen)}}">
                                    @error('aula_examen')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
    ...
    @section('script')
        ...
        @include('examenes_suficiencia.scripts.edit-scripts')
    @endsection
@endcan
