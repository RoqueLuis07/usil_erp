    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="showModal">Ver Formación Académica</h5>
...
<!-- createModal -->
    @can('crear_formaciones_academicas')
        <div class="modal fade flip" id="createModal" tabindex="-1" aria-labelledby="createModal" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="store-form">
                        <div class="modal-header bg-light p-3">
                            <h5 class="modal-title" id="createModal">Agregar Formación Académica</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label" for="nombre-formacion-academica">Nombre <span class="text-danger">(*)</span></label>
                                    <input type="text" class="form-control @error('nombre_formacion_academica') is-invalid @enderror" id="nombre-formacion-academica" name="nombre_formacion_academica" value="{{old('nombre_formacion_academica')}}">
                                    @error('nombre_formacion_academica')
        ...
        <div class="modal fade flip" id="editModal" tabindex="-1" aria-labelledby="editModal" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="update-form">
                        <div class="modal-header bg-light p-3">
                            <h5 class="modal-title" id="editModal">Actualizar Formación Académica</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label" for="nombre-formacion-academica-edit">Nombre <span class="text-danger">(*)</span></label>
                                    <input type="text" class="form-control @error('nombre_formacion_academica') is-invalid @enderror" id="nombre-formacion-academica-edit" name="nombre_formacion_academica" value="{{old('nombre_formacion_academica')}}">
                                    @error('nombre_formacion_academica')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
