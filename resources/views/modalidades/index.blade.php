@can('ver_modalidades')
    ...
    @section('title') Modalidades @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Modalidades @endslot
        @endcomponent

        @include('modalidades.scripts.messages-scripts')
        @include('modalidades.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Modalidades</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="modalidades-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="modalidades-list">
    ...
    @section('script')
        ...
        @include('modalidades.scripts.index-scripts')
    @endsection
@endcan
