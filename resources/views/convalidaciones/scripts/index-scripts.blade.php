<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['numero_solicitud', 'alumno', 'carrera', 'carrera_origen', 'universidad_origen', 'tipo'],
            page: 50,
            pagination: true
        };
        var convalidacionesList = new List('convalidaciones-list', options);
        convalidacionesList.on('updated', function(list) {
