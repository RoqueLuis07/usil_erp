<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['numero_solicitud', 'alumno', 'carrera', 'carrera_origen', 'universidad_origen'],
            page: 50,
            pagination: true
        };
        var convalidaciones_internasList = new List('convalidaciones_internas-list', options);
        convalidaciones_internasList.on('updated', function(list) {
