                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="dictaminar-form-{{$detalle->id}}" action="{{route('convalidaciones_internas.dictaminar', $detalle->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        <label class="form-label" for="carga_horaria_materia_origen-{{$detalle->id}}">Carga Horaria Origen</label>
                                        <input type="text" class="form-control text-center" id="carga_horaria_materia_origen-{{$detalle->id}}" value="{{$detalle->carga_horaria_materia_origen}}" readonly>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-8 mb-3">
                                        <label class="form-label" for="materia">Materia a Convalidar <span class="text-danger">(*)</span></label>
                                    ...
                                    <div class="col-lg-12 mb-3" id="div-dictamen">
                                        @if ($detalle->ubicacion_dictamen)
                                            <div class="d-flex justify-content-center">
                                                ...
                                                @can('eliminar_adjunto_dictamen_convalidaciones_internas')
                                ...
                                <div class="row">
                                    <div class="hstack gap-2 justify-content-center">
                                        <button type="button" class="btn btn-success dictaminar-btn" id="dictaminar-btn" data-id="{{$detalle->id}}" data-url="{{route('convalidaciones_internas.dictaminar', $detalle->id)}}">
                            ...
                            @can('eliminar_adjunto_dictamen_convalidaciones_internas')
                                <form action="{{route('convalidaciones_internas.destroy_dictamen', $detalle->id)}}" method="delete" id="destroy-dictamen-form-{{$detalle->id}}">
                                    @csrf
                                </form>
                            @endcan
                        </div>
            ...
            <div class="modal fade flip" id="aprobarModal-{{$detalle->id}}" tabindex="-1" aria-labelledby="aprobarModal-{{$detalle->id}}" role="dialog">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="text-muted">Por favor, complete los <code>campos marcados</code> para poder agregar un registro con éxito.</p>
                            <form id="aprobar-form-{{$detalle->id}}" action="{{route('convalidaciones_internas.aprobar', $detalle->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8 mb-3">
                                        <label class="form-label" for="alumno">Alumno</label>
                                    ...
                                    <div class="col-lg-12 mb-3" id="div-resolucion">
                                        @if ($detalle->ubicacion_resolucion)
                                            <div class="d-flex justify-content-center">
                                                ...
                                                @can('eliminar_adjunto_resolucion_convalidaciones_internas')
                                ...
                                <div class="row">
                                    <div class="hstack gap-2 justify-content-center">
                                        <button type="button" class="btn btn-success aprobar-btn" id="aprobar-btn" data-id="{{$detalle->id}}" data-url="{{route('convalidaciones_internas.aprobar', $detalle->id)}}">
                            ...
                            @can('eliminar_adjunto_resolucion_convalidaciones_internas')
                                <form action="{{route('convalidaciones_internas.destroy_resolucion', $detalle->id)}}" method="delete" id="destroy-resolucion-form-{{$detalle->id}}">
                                    @csrf
                                </form>
                            @endcan
                        </div>
