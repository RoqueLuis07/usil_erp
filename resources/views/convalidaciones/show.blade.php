@if (Auth::user()->can('ver_convalidaciones_externas') || Auth::user()->can('ver_convalidaciones_internas'))
    ...
    @section('title') Ver Convalidación @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            @slot('li_1') Convalidaciones @endslot
            @slot('title') Ver Convalidación @endslot
        @endcomponent
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-wrap">
                            <div class="col-lg-6">
                                <h4 class="card-title mb-0">Visualizar convalidación</h4>
                            </div>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('convalidaciones.index')}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
