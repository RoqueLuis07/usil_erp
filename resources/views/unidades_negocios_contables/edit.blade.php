@can('editar_unidades_negocios_contables')
    ...
    @section('title') Editar Unidad de Negocio @endsection
    @section('css')
        <link rel="stylesheet" href="{{ URL::asset('build/libs/sweetalert2/sweetalert2.min.css') }}">
    @endsection
    @section('content')
        @component('components.breadcrumb')
            @slot('li_1') Unidades de Negocio @endslot
            @slot('title') Editar Unidad de Negocio  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('unidades_negocios_contables.update', $unidad_negocio->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Actualizar unidad de negocio</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{old('nombre', $unidad_negocio->nombre)}}">
                                    @error('nombre')
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @foreach ($unidad_negocio->subcunidadesNegociosContables as $key => $detalle)
    ...
    @section('script')
        ...
        @include('unidades_negocios_contables.scripts.edit-scripts')
        @include('unidades_negocios_contables.scripts.edit-detalles-scripts')
    @endsection
@endcan
