@can('crear_recibos')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3">
                                    <label class="form-label" for="cliente">N° Documento <span class="text-danger">(*)</span></label>
                                    <input type="text" class="form-control" id="numero_documento" name="numero_documento" value="{{old('numero_documento')}}" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-2 mb-3">
                                ...
                                <div class="card-body">
                                    <div class="mb-2 fila" id="fila-0">
                                        <div class="row d-flex flex-wrap justify-content-center">
                                            <div class="col-lg-3 mb-2 text-center" id="div-venta-0">
                                                <label class="form-label label-venta">Factura <span class="text-danger">(*)</span></label>
                                                <select class="selectpicker form-control venta-0 venta @error('detalles.0.venta') is-invalid @enderror" id="venta-0" name="detalles[0][venta]" data-live-search="true" data-id="0" disabled>
                                                    <option value="" selected disabled>Seleccionar...</option>
                                                    
                                                </select>
                                                @error('detalles.0.venta')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{$message}}</strong>
                                                    </span>
                                                @enderror
                                            </div>
                                            <div class="col-lg-2 mb-2 text-center" id="div-saldo_pendiente-0">
                                                <label class="form-label label-saldo_pendiente" for="saldo_pendiente-0">Saldo Pendiente</label>
                                                <input type="text" class="form-control text-center saldo_pendiente saldo_pendiente-0" id="saldo_pendiente-0" data-id="0" readonly>
                                            </div>
                                            <div class="col-lg-2 mb-2 text-center" id="div-monto-0">
                                                <label class="form-label label-monto" for="monto-0">Monto a Cobrar <span class="text-danger">(*)</span></label>
                                                <input type="text" class="form-control text-center monto-0 monto @error('detalles.0.monto') is-invalid @enderror" id="monto-0" name="detalles[0][monto]" value="{{old('detalles.0.monto')}}" data-id="0">
    ...
    @section('script')
        ...
        @include('recibos.scripts.create-scripts')
        @include('recibos.scripts.create-detalles-scripts')
    @endsection
@endcan
