<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['fecha', 'cliente', 'numero_nota_credito', 'numero_venta', 'monto'],
            page: 50,
            pagination: true
        };
        var notas_creditosList = new List('notas_creditos-list', options);
        notas_creditosList.on('updated', function(list) {
