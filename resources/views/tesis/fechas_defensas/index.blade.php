@can('ver_fechas_defensas_tesis')
    ...
    @section('content')
        ...
        @include('tesis.fechas_defensas.scripts.messages-scripts')
        @include('tesis.fechas_defensas.modals.index-modals')
                            ...
                            <div class="row g-4 mb-3">
                                <div class="col-lg-8">
                                    @can('crear_fechas_defensas_tesis')
                                        <a class="btn btn-success" href="{{route('fechas_defensas_tesis.create')}}"><i class="ri-add-line align-bottom me-1"></i>Agregar</a>
                                    @endcan
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($fechas as $fecha)
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-sm btn-primary" href="{{route('fechas_defensas_tesis.show', $fecha->id)}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ver"><i class="ri-eye-fill"></i></a>
                                                    @if ($fecha->estado == 'LI')
                                                        @can('editar_fechas_defensas_tesis')
                                                            <a type="button" class="btn btn-sm btn-info" href="{{route('fechas_defensas_tesis.edit', $fecha->id)}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Editar"><i class="ri-edit-fill"></i></a>
                                                        @endcan
    ...
    @section('script')
        ...
        @include('tesis.fechas_defensas.scripts.index-scripts')
    @endsection
@endcan
