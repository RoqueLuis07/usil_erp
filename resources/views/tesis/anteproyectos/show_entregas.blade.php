@can('ver_entregas_anteproyectos_tesis')
    ...
    @section('content')
        @component('components.breadcrumb')
            @slot('li_1') Ver Anteproyecto de Trabajo Final de Grado @endslot
        ...
        @include('tesis.anteproyectos.modals.show_entregas-modals')
                ...
                <div class="col-lg-12">
                                ...
                                @forelse ($anteproyecto->entregas as $entrega)
                                    <a class="list-group-item list-group-action">
                                        <div class="float-end">
                                            ...
                                            @if ($anteproyecto->estado != 'AP')
                                                @can('eliminar_entrega_anteproyectos_tesis')
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('anteproyectos_tesis.show', $anteproyecto->inscripcion_id)}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @section('script')
        ...
        @include('tesis.anteproyectos.scripts.show_entregas-scripts')
    @endsection
@endcan
