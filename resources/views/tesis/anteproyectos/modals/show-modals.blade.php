@foreach ($tema->anteproyectos as $anteproyecto)
    <!-- approveModal -->
        @can('aprobar_bloques_anteproyectos_tesis')
            <div class="modal fade flip" id="approveModal-{{$anteproyecto->id}}" tabindex="-1" aria-labelledby="approveModal-{{$anteproyecto->id}}" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('anteproyectos_tesis.aprobar', $anteproyecto->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
    ...
    <!-- desapproveModal -->
        @can('anular_aprobacion_bloques_anteproyectos_tesis')
            <div class="modal fade flip" id="desapproveModal-{{$anteproyecto->id}}" tabindex="-1" aria-labelledby="desapproveModal-{{$anteproyecto->id}}" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                            ...
                            <form action="{{route('anteproyectos_tesis.anular_aprobacion', $anteproyecto->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
