@can('editar_rubricas_alumnos_tesis')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('cargar_rubricas_tesis.update_proceso', $rubrica->inscripcion_id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" id="inscripcion_id" value="{{$rubrica->inscripcion_id}}">
                            <div class="row">
                                            ...
                                            <tbody class="list form-check-all">
                                                @foreach ($rubrica->detalles as $key => $detalle)
                                                    ...
                                                    <tr class="align-middle">
                                                        ...
                                                        <td class="text-center border-end" id="puntos-{{$key}}">{{$detalle->rubricaDetalle->puntos}}</td>
                                                        <td class="text-center">
                                                            <div class="col-lg-3 mx-auto">
                                                                <input type="hidden" name="detalles[{{$key}}][id]" value="{{$detalle->rubrica_detalle_id}}">
                                                                <input type="text" class="form-control text-center puntaje_obtenido puntaje_obtenido-{{$key}} @error('detalles.' . $key . '.puntaje_obtenido') is-invalid @enderror" id="puntaje_obtenido-{{$key}}" name="detalles[{{$key}}][puntaje_obtenido]" value="{{old('detalles.' . $key . '.puntaje_obtenido', $detalle->puntos_obtenidos)}}" data-id="{{$key}}">
    ...
    @section('script')
        ...
        @include('tesis.cargar_rubricas.proceso.scripts.edit-scripts')
    @endsection
@endcan
