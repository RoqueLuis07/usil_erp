{{-- @can('crear inscripciones temas tesis') --}}
    @extends('layouts.master')
    @section('title') Inscripción de Tema de Trabajo Final de Grado @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Inscripción de Tema de Trabajo Final de Grado  @endslot
        @endcomponent
    ...
    @section('script')
        ...
        @include('tesis.inscripciones_temas.scripts.create-scripts')
    @endsection
{{-- @endcan --}}
