@can('ver_bloques_proyectos_tesis')
    ...
    @section('title') Bloques de Proyectos @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Bloques de Proyectos @endslot
        @endcomponent

        @include('tesis.bloques_proyectos.scripts.messages-scripts')
        @include('tesis.bloques_proyectos.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Bloques de Proyectos</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="bloques-list">
    ...
    @section('script')
        ...
        @include('tesis.bloques_proyectos.scripts.index-scripts')
    @endsection
@endcan
