@can('ver_bloques_anteproyectos_tesis')
    ...
    @section('content')
        ...
        @include('tesis.bloques_anteproyectos.scripts.messages-scripts')
        @include('tesis.bloques_anteproyectos.modals.index-modals')
                    ...
                    <div class="card-body">
                        <div id="bloques-list">
                            <div class="row g-4 mb-3">
                                <div class="col-lg-8">
                                    @can('crear_bloques_anteproyectos_tesis')
    ...
    @section('script')
        ...
        @include('tesis.bloques_anteproyectos.scripts.index-scripts')
    @endsection
@endcan
