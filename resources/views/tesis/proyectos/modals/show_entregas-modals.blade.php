            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-entrega-form" action="{{route('proyectos_tesis.save_entrega', $proyecto->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="hstack gap-2 justify-content-center">
                                    <button type="button" class="btn btn-success" id="save-entrega-btn" data-id="{{$proyecto->id}}">Guardar</button>
        ...
        <div class="modal fade flip" id="addCorreccionModal" tabindex="-1" aria-labelledby="addCorreccionModal" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-correccion-form" action="{{route('proyectos_tesis.save_correccion', $proyecto->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 mt-3" id="div-archivo">
                            ...
                            <div class="row">
                                <div class="hstack gap-2 justify-content-center">
                                    <button type="button" class="btn btn-success" id="save-correccion-btn" data-id="{{$proyecto->id}}">Guardar</button>
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cerrar</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-lg-7 mb-3">
                                ...
                                <input type="text" class="form-control" id="autor" @if ($entrega->entrega == false) value="{{$entrega->proyecto->inscripcion->tutor->primer_nombre}} {{$entrega->proyecto->inscripcion->tutor->primer_apellido}}" @else value="{{$entrega->proyecto->inscripcion->alumno->primer_nombre}} {{$entrega->proyecto->inscripcion->alumno->primer_apellido}}" @endif readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div>
                                        @php
                                            ...
                                            $nombre = $tipo . $entrega->numero . '_proyecto_bloque_' . $entrega->proyecto->bloque->numero;
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form action="{{route('proyectos_tesis.delete_entrega', $entrega->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                        @php
