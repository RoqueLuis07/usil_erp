@can('ver_proyectos_tesis')
    ...
    @section('title') Proyectos de Trabajos Finales de Grado @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Proyectos de Trabajos Finales de Grado @endslot
        @endcomponent
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Proyectos de Trabajos Finales de Grado</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="temas-list">
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($temas as $tema)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge @if ($tema->estado == 'AA')
                                                            bg-success-subtle text-success text-uppercase"> Ap. Ante.
                                                ...
                                                <td>
                                                    <a type="button" class="btn btn-sm btn-primary" href="{{route('proyectos_tesis.show', $tema->id)}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ver"><i class="ri-eye-fill"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
    ...
    @section('script')
        ...
        @include('tesis.proyectos.scripts.index-scripts')
    @endsection
@endcan
