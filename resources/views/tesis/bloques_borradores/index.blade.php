@can('ver_bloques_borradores_tesis')
    ...
    @section('content')
        ...
        @include('tesis.bloques_borradores.scripts.messages-scripts')
        @include('tesis.bloques_borradores.modals.index-modals')
    ...
    @section('script')
        ...
        @include('tesis.bloques_borradores.scripts.index-scripts')
    @endsection
@endcan
