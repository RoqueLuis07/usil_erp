@can('editar_cajas_cuentas_movimientos')
    ...
    @section('title') Editar Movimiento entre Caja y Cuenta Bancaria @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Editar Movimiento entre Caja y Cuenta Bancaria  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('movimientos_cajas_bancos.update', $movimiento->id)}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <select class="selectpicker form-control @error('caja') is-invalid @enderror" id="caja" name="caja" data-live-search="true">
                                        ...
                                        @foreach ($cajas as $caja)
                                            <option value="{{$caja->id}}" @if (old('caja') == strval($caja->id) || $movimiento->caja_id == strval($caja->id)) selected @endif>{{$caja->nombre}}</option>
                                        @endforeach
                                    </select>
                                    @error('caja')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <select class="selectpicker form-control @error('cuenta_bancaria') is-invalid @enderror" id="cuenta_bancaria" name="cuenta_bancaria" data-live-search="true">
                                        ...
                                        @foreach ($cuentas_bancarias as $cuenta_bancaria)
                                            <option value="{{$cuenta_bancaria->id}}" @if (old('cuenta_bancaria') == strval($cuenta_bancaria->id) || $movimiento->cuenta_bancaria_id == strval($cuenta_bancaria->id)) selected @endif data-subtext="{{$cuenta_bancaria->numero_cuenta}}">{{$cuenta_bancaria->banco->nombre}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('monto') is-invalid @enderror" id="monto" name="monto" placeholder="0" value="{{old('monto', $movimiento->monto)}}">
                                    @error('monto')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="col-lg-1 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="moneda" name="moneda" value="{{old('moneda', $movimiento->moneda)}}" readonly>
                                </div>
                            </div>
                            <div class="row">
