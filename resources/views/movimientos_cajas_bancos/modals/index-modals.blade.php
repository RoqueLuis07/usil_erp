        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    <h5 class="modal-title" id="showModal-{{$movimiento->id}}">Ver Movimiento entre Caja y Banco</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-5 mb-3">
                            ...
                            <input type="text" class="form-control" id="caja" value="{{$movimiento->caja->nombre}}" readonly>
                        </div>
                        ...
                        <div class="col-lg-5 mb-3">
                            ...
                            <input type="text" class="form-control" id="cuenta_bancaria" value="{{$movimiento->cuentaBancaria->nombre}}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            @if ($movimiento->tipo_movimiento == 7)
                                value="{{number_format($movimiento->monto, 0, ',', '.')}} GS"
                            @elseif ($movimiento->tipo_movimiento == 8)
                                @if ($movimiento->cuentaBancaria->moneda_id == 1)
                                    value="{{number_format($movimiento->monto, 0, ',', '.')}} {{$movimiento->cuentaBancaria->moneda->codigo}}"
                                @else
                                    value="{{number_format($movimiento->monto, 2, ',', '.')}} {{$movimiento->cuentaBancaria->moneda->codigo}}"
                                @endif
                            @endif
                            readonly>
                        </div>
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="estado" @if ($movimiento->estado == 'PE') value="PENDIENTE" @elseif ($movimiento->estado == 'AP') value="APROBADO" @elseif ($movimiento->estado == 'RE') value="RECHAZADO" @endif readonly>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="reject-form-{{$movimiento->id}}" action="{{route('movimientos_cajas_bancos.reject', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="unreject-form-{{$movimiento->id}}" action="{{route('movimientos_cajas_bancos.unreject', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="approve-form-{{$movimiento->id}}" action="{{route('movimientos_cajas_bancos.approve', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="unapprove-form-{{$movimiento->id}}" action="{{route('movimientos_cajas_bancos.unapprove', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="destroy-form-{{$movimiento->id}}" action="{{route('movimientos_cajas_bancos.destroy', $movimiento->id)}}" method="delete">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
