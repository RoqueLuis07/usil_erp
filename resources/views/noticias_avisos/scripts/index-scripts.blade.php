<script type="module">
    var noticias_avisosList;
    $(document).ready(function() {
        var options = {
            valueNames: ['fecha', 'tipo', 'titulo', 'creado'],
            page: 50,
            pagination: true
        };
        noticias_avisosList = new List('noticias_avisos-list', options);
        noticias_avisosList.on('updated', function(list) {
    ...
    function aplicarFiltros() {
        ...
        noticias_avisosList.filter(function (item) {
            var tipoMatch = !tipoSeleccionado || item.values().tipo === tipoSeleccionado;
