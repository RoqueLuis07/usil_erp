<script type="module">
    ...
    $(document).on('click', '.btn-add', function () {
        ...
        if ($('.nombre-' + nro_ultima_fila).val() != '') {
            ...
            subcentro_accion_add = $('#btn-add-' + fila).detach();
            ...
            subcentro_accion_add = $('#btn-add-' + nro_nueva_fila);
    ...
    $(document).on('click', '.btn-erase', function () {
        ...
        subcentro_accion_add.appendTo('#acciones-' + nro_ultima_fila);
