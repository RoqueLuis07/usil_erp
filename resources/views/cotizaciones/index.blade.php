@can('ver_cotizaciones')
    ...
    @section('content')
        ...
        @include('cotizaciones.scripts.messages-scripts')
        @include('cotizaciones.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Cotizaciones</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="cotizaciones-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="cotizaciones-list">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ningúna cotización según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('cotizaciones.scripts.index-scripts')
    @endsection
@endcan
