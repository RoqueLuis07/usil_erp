@can('crear_carreras')
    ...
    @section('title') Agregar Carrera @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Agregar Carrera  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('carreras.store')}}" method="post" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Nueva carrera</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('abreviatura') is-invalid @enderror" id="abreviatura" name="abreviatura" placeholder="Escriba una abreviatura" value="{{old('abreviatura')}}">
                                    @error('abreviatura')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-lg-2 mb-3">
                                    ...
                                    <select class="selectpicker form-control @error('tipo_carrera') is-invalid @enderror" id="tipo_carrera" name="tipo_carrera" data-live-search="true">
                                        ...
                                        @foreach ($tipos_carreras as $tipo_carrera)
                                            <option value="{{$tipo_carrera->id}}" @if(old('tipo_carrera') == strval($tipo_carrera->id)) selected @endif>{{$tipo_carrera->nombre}}</option>
                                        @endforeach
                                    </select>
                                    @error('tipo_carrera')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-2 mb-3">
                                    <label class="form-label" for="cantidad_semestres">Cant. de Semestres <span class="text-danger">(*)</span></label>
                                    <input type="text" class="form-control @error('cantidad_semestres') is-invalid @enderror" id="cantidad_semestres" name="cantidad_semestres" placeholder="Escriba una cantidad de semestres" value="{{old('cantidad_semestres')}}">
                                ...
                                <div class="col-lg-2 mb-3 text-center">
                                    ...
                                    <div class="text-center">
                                        <div class="btn-group @error('doble_grado') is-invalid @enderror" role="group">
                                            <input type="radio" class="btn-check" id="doble_grado1" name="doble_grado" value="false" @if (old('doble_grado') == 'false') checked @endif>
                                            <label class="btn btn-outline-danger" for="doble_grado1">No</label>
                                            <input type="radio" class="btn-check" id="doble_grado2" name="doble_grado" value="true" @if (old('doble_grado') == 'true') checked @endif>
    ...
    @section('script')
        ...
        @include('carreras.scripts.create-scripts')
    @endsection
@endcan
