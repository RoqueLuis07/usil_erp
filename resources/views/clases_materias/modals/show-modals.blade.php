@foreach ($clase->alumnoAsistencias as $key => $asistencia)
    <!-- observacionModal -->
            ...
            <div class="modal fade flip" id="cambiarAsistenciaModal-{{$asistencia->id}}" tabindex="-1" aria-labelledby="cambiarAsistenciaModal-{{$asistencia->id}}" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('alumnos_asistencias.update', $asistencia->id)}}" method="post" id="change-asistencia-form-{{$asistencia->id}}">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                ...
                                <div class="row">
                                    <div class="hstack gap-2 justify-content-center">
                                        <button type="button" class="btn btn-success change-asistencia" data-id="{{$asistencia->id}}" data-url="{{route('alumnos_asistencias.update', $asistencia->id)}}">Cambiar</button>
                                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cerrar</button>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="modal fade flip" id="changeObservacionModal-{{$asistencia->id}}" tabindex="-1" aria-labelledby="changeObservacionModal-{{$asistencia->id}}" role="dialog">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('alumnos_asistencias.update_observacion', $asistencia->id)}}" method="post" id="change-observacion-form-{{$asistencia->id}}">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                                ...
                                <div class="row">
                                    <div class="hstack gap-2 justify-content-center">
                                        <button type="button" class="btn btn-success change-observacion" data-id="{{$asistencia->id}}" data-url="{{route('alumnos_asistencias.update_observacion', $asistencia->id)}}">Actualizar</button>
                                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cerrar</button>
                                    </div>
                                </div>
                            </form>
