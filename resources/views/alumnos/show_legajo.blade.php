@can('ver_legajos_alumnos')
    ...
    @section('content')
        ...
        @include('alumnos.modals.show-legajo-modals')
                                                ...
                                                <div class="card card-body text-center">
                                                    <div class="mx-auto mb-3">
                                                        ...
                                                        @can('eliminar_legajos_alumnos')
                                                            ...
                                                            <form action="{{route('alumnos.eliminar_legajo', $legajo->id)}}" method="delete" id="delete-legajo-form-{{$legajo->id}}">
                                                                @csrf
                                                            </form>
                                                        @endcan
                                                    </div>
    ...
    @section('script')
        ...
        @include('alumnos.scripts.show-legajo-scripts')
    @endsection
@endcan
