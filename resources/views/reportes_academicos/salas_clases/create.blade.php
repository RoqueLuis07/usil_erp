@can('ver_reportes_academicos_salas_clases')
    ...
    @section('content')
        ...
        <div class="row">
            <form action="{{route('reportes_academicos.pdf_salas_clases')}}" method="get" target="_blank" id="store-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Generar Reporte de Salas de Clases</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
    ...
    @section('script')
        ...
        @include('reportes_academicos.salas_clases.scripts.create-scripts')
    @endsection
@endcan
