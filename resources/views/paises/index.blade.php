@can('ver_paises')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Países @endslot
        @endcomponent

        @include('paises.scripts.messages-scripts')
        @include('paises.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Países</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="paises-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="paises-list">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ningún país según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('paises.scripts.index-scripts')
    @endsection
@endcan
