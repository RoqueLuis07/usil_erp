@can('ver_monedas')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Monedas @endslot
        @endcomponent

        @include('monedas.scripts.messages-scripts')
        @include('monedas.modals.index-modals')

        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Lista de Monedas</h4>
                    </div>
                    <!-- end card header -->
                    <div class="card-body">
                        <div id="monedas-list">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="monedas-list">
                                ...
                                <div class="noresults" style="display: none">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mb-0">No pudimos encontrar ningúna moneda según tus parámetros de búsqueda.</p>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        ...
        @include('monedas.scripts.index-scripts')
    @endsection
@endcan
