@can('ver_clases_tutorias')
    ...
    @section('content')
        @component('components.breadcrumb')
            @slot('li_1') Clases de Tutoría @endslot
            @slot('title') Ver Clase de Tutoría @endslot
        @endcomponent

        @include('tutorias.clases.modals.show-modals')
                ...
                <div class="col-lg-12">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn
                                                                            ...
                                                                            @endif
                                                                            @if ($clase->tutoria->estado == 'FI' || !Auth::user()->can('editar_asistencias_alumnos_tutorias'))
                                                                                disabled
                                                                            @endif>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <br>
                            {{$clase->tutoria->docente->usuario->name}}, en fecha: {{\Carbon\Carbon::parse($clase->created_at)->format('d/m/Y H:i:s')}}
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 text-end mb-3">
                            <a type="button" class="btn btn-danger me-2" href="{{route('tutorias_clases.index', $clase->tutoria_id)}}">Volver</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @section('script')
        ...
        @include('tutorias.clases.scripts.show-scripts')
    @endsection
@endcan
