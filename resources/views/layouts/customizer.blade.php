...
<div class="customizer-setting d-none d-md-block">
    <div class="btn btn-info p-2 text-uppercase rounded-end-0 shadow-lg" data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
        <i class="bi bi-gear mb-1"></i> Diseñador
    </div>
</div>
<form action="{{route('configuracion.update', Auth::id())}}" method="post">
    @csrf
    <!-- Theme Settings -->
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
            <div class="me-2">
                <h6 class="mb-1 fs-lg text-white">Garage 500 - Diseñador</h6>
                <p class="text-white fs-md text-opacity-75 mb-0">Elije tu forma de ver...</p>
            </div>
        ...
        <div class="offcanvas-body p-0">
            <div data-simplebar class="h-100">
                <div class="p-4">
                    ...
                    <h6 class="mt-4 fs-md mb-1">Color del tema</h6>
                    ...
                    <div id="layout-width">
                        <h6 class="mt-4 fs-md mb-1">Ancho de la disposición</h6>
                    ...
                    <div id="layout-position">
                        <h6 class="mt-4 fs-md mb-1">Posición de la disposición</h6>
                    ...
                    <h6 class="mt-4 fs-md mb-1">Color de la barra superior</h6>
                    ...
                    <div id="sidebar-size">
                        <h6 class="mt-4 fs-md mb-1">Tamaño de la barra lateral</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-sm text-center fw-medium mt-2">Pequeño (solo íconos)</h5>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-sm text-center fw-medium mt-2">Pequeño (flotante)</h5>
                            </div>
                        </div>
                    </div>

                    <div id="sidebar-view">
                        <h6 class="mt-4 fs-md mb-1">Vista de la barra lateral</h6>
                    ...
                    <div id="sidebar-color">
                        <h6 class="mt-4 fs-md mb-1">Color de la barra lateral</h6>
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a class="btn btn-danger w-100" id="reset-layout">Restaurar</a>
                </div>
            </div>
        </div>
    </div>
</form>
<form action="{{route('configuracion.reset', Auth::id())}}" method="post" id="reset-form">@csrf</form>
