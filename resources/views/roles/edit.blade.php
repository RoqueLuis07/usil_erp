@can('editar_roles')
    ...
    @section('content')
        ...
        <div class="row">
            <form method="post" action="{{ route('roles.update', $rol->id) }}" id="update-form">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Actualizar rol</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Administrador" @if ($errors->any()) value="{{old('name')}}" @else value="{{$rol->name}}" @endif>
                                    @error('name')
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="cant_usuarios" value="{{$cant_usuarios}}" readonly>
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-label" for="cant_permisos">Permisos Seleccionados</label>
                                    <input type="text" class="form-control" id="cant_permisos" value="{{$cant_permisos}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @section('script')
        ...
        @include('roles.scripts.edit-scripts')
    @endsection
@endcan
