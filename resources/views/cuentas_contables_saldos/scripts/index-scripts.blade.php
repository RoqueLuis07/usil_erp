<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['numero_cuenta', 'cuenta', 'debe_mes', 'haber_mes', 'saldo_anho', 'debe_anho', 'haber_anho', 'saldo_anho'],
            page: 1000,
            pagination: true
        };
        var saldosList = new List('saldos-list', options);
        saldosList.on('updated', function(list) {
