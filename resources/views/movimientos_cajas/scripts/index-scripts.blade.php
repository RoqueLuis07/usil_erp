<script type="module">
    $(document).ready(function() {
        var options = {
            valueNames: ['tipo_movimiento', 'caja_origen', 'caja_destino', 'fecha'],
            page: 50,
            pagination: true
        };
        var movimientos_cajasList = new List('movimientos_cajas-list', options);
        movimientos_cajasList.on('updated', function(list) {
