<script type="module">
    ...
    $(document).ready(function () {
        ...
        if (error) {
            ...
            if (tipo == 1) {
                var caja_destino = movimiento.caja_destino_id;
                if (caja_destino) {
                    caja_destino = parseInt(caja_destino);
                    $('#caja_destino').selectpicker('destroy');
                    $('#caja_destino').empty();
                ...
                var caja_origen = movimiento.caja_origen_id;
                if (caja_origen) {
                    caja_origen = parseInt(caja_origen);
                    $('#caja_origen').selectpicker('destroy');
                    $('#caja_origen').empty();
                ...
                var caja_origen = movimiento_caja_origen_id;
                if (caja_origen) {
                    caja_origen = parseInt(caja_origen);
                    $('#caja_origen').selectpicker('destroy');
                    $('#caja_origen').empty();
    ...
    $('#update-btn').click(function () {
        ...
        swalWithBootstrapButtons.fire({
            title: '¿Está seguro de actualizar el movimiento de caja?',
            icon: 'question',
            showCancelButton: true,
