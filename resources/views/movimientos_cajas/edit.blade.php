@can('editar_cajas_movimientos')
    ...
    @section('title') Editar Movimiento de Caja @endsection
    @section('css')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @slot('title') Editar Movimiento de Caja  @endslot
        @endcomponent

        <div class="row">
            <form action="{{route('movimientos_cajas.update', $movimiento->id)}}" method="post" id="update-form">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Actualizar movimiento de caja</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('monto') is-invalid @enderror" id="monto" name="monto" placeholder="0" value="{{old('monto', number_format($movimiento->monto, 0, ',', '.'))}}">
                                    @error('monto')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
    ...
    @section('script')
        ...
        @include('movimientos_cajas.scripts.edit-scripts')
    @endsection
@endcan
