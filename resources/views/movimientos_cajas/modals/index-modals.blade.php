        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    <h5 class="modal-title" id="showModal-{{$movimiento->id}}">Ver Movimiento de Caja</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-5 mb-3">
                            <label class="form-label" for="caja_origen">Caja Origen</label>
                            <input type="text" class="form-control" id="caja_origen" @if ($movimiento->caja_origen_id) value="{{$movimiento->cajaOrigen->nombre}}" @else value="---" @endif readonly>
                        </div>
                        ...
                        <div class="col-lg-5 mb-3">
                            <label class="form-label" for="caja_destino">Caja Destino</label>
                            <input type="text" class="form-control" id="caja_destino" @if ($movimiento->caja_destino_id) value="{{$movimiento->cajaDestino->nombre}}" @else value="---" @endif readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            <label class="form-label" for="monto">Monto</label>
                            <input type="text" class="form-control" id="monto" value="{{number_format($movimiento->monto, 0, ',', '.')}}" readonly>
                        </div>
                        <div class="col-lg-6 mb-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="reject-form-{{$movimiento->id}}" action="{{route('movimientos_cajas.reject', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="unreject-form-{{$movimiento->id}}" action="{{route('movimientos_cajas.unreject', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="approve-form-{{$movimiento->id}}" action="{{route('movimientos_cajas.approve', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="unapprove-form-{{$movimiento->id}}" action="{{route('movimientos_cajas.unapprove', $movimiento->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="destroy-form-{{$movimiento->id}}" action="{{route('movimientos_cajas.destroy', $movimiento->id)}}" method="delete">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12 mb-3 text-center">
