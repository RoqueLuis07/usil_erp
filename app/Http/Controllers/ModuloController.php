...
class ModuloController extends Controller
{
    ...
    {
        $this->authorize('ver_modulos_ubs');

        return view('ubs/modulos.index');
    }
    ...
    public function index_ajax()
    {
        ...
        try {
            $modulos = Modulo::where('es_maestria', false)->orderBy('nombre_fantasia', 'asc')->get();
            return response()->json([
                'modulos' => $modulos,
            ]);
        } catch (\Exception $e) {
            return redirect()->route('modulos.index')->with('error-message', $e->getMessage());
        }
    }
    ...
    {
        $this->authorize('crear_modulos_ubs');
    ...
    {
        $this->authorize('editar_modulos_ubs');
    ...
    {
        $this->authorize('inactivar_modulos_ubs');
    ...
    {
        $this->authorize('activar_modulos_ubs');
    ...
    {
        $this->authorize('eliminar_modulos_ubs');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            if (stripos($e->getMessage(), 'Foreign key violation')) {
                return redirect()->route('modulos.index')->with('error-message', 'El módulo ' . $modulo->nombre_fantasia . ' no se puede eliminar. Está siendo utilizado por otro registro dentro del sistema.');
            } else {
                return redirect()->route('modulos.index')->with('error-message', $e->getMessage());
            }
        }
