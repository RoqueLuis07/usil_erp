...
return new class extends Migration
{
    ...
    {
        Schema::create('anteproyectos_tesis', function (Blueprint $table) {
            $table->id();
            $table->foreignId('inscripcion_id')->constrained('inscripciones_temas_tesis');
            $table->foreignId('bloque_id')->constrained('bloques_anteproyectos_tesis');
    ...
    {
        Schema::dropIfExists('anteproyectos_tesis');
    }
};
