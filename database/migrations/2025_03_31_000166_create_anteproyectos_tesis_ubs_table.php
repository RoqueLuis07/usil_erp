...
return new class extends Migration
{
    ...
    {
        Schema::create('anteproyectos_tesis_ubs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('inscripcion_id')->constrained('inscripciones_temas_tesis_ubs');
            $table->foreignId('bloque_id')->constrained('bloques_anteproyectos_tesis_ubs');
    ...
    {
        Schema::dropIfExists('anteproyectos_tesis_ubs');
    }
};
