...
return new class extends Migration
{
    ...
    {
        Schema::create('borradores_tesis', function (Blueprint $table) {
            $table->id();
            $table->foreignId('inscripcion_id')->constrained('inscripciones_temas_tesis');
            $table->foreignId('bloque_id')->constrained('bloques_borradores_tesis');
    ...
    {
        Schema::dropIfExists('borradores_tesis');
    }
};
