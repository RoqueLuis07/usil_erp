...
//Academico
    //Alumnos
        ...
        Route::post('alumnos', 'AlumnoController@index')->name('alumnos.index');
        ...
        Route::post('alumnos/actualizar/{id}', 'AlumnoController@update')->name('alumnos.update');
    ...
    //Matriculaciones
        ...
        Route::post('matriculaciones', 'MatriculacionController@index')->name('matriculaciones.index');
    ...
    //Docentes
        ...
        Route::post('docentes', 'DocenteController@index')->name('docentes.index');
        ...
        //Salarios
            ...
            Route::post('docentes/salarios', 'DocenteSalarioController@index')->name('docentes_salarios.index');
    ...
    //Gestiones
        //Examenes de Suficiencia
            ...
            Route::post('examenes_suficiencia/actas/generar', 'ExamenSuficienciaActaEvaluacionController@generate')->name('examenes_suficiencia.generate_acta');
            ...
            Route::delete('examenes_suficiencia/actas/eliminar_acta/{id}', 'ExamenSuficienciaActaEvaluacionController@eliminar_acta')->name('examenes_suficiencia.eliminar_acta');
        //Materias por Semestres
            ...
            //Evaluaciones
                ...
                Route::post('materias_evaluaciones/agregar', 'MateriaEvaluacionController@store')->name('materias_evaluaciones.store');
                Route::get('materias_evaluaciones/actualizar/{id}', 'MateriaEvaluacionController@update')->name('materias_evaluaciones.update');
                Route::post('materias_evaluaciones/actualizar/{id}', 'MateriaEvaluacionController@update')->name('materias_evaluaciones.update');
            //Asistencias
        ...
        //Actas
            ...
            Route::delete('actas_evaluaciones/eliminar_acta/{id}', 'ActaEvaluacionController@eliminar_acta')->name('actas_evaluaciones.eliminar_acta');
        ...
        //Clases
            ...
            Route::post('clases_materias', 'ClaseMateriaController@index')->name('clases_materias.index');
        ...
        //Seguimiento Docente
            ...
            Route::post('seguimiento_docente', 'SeguimientoDocenteController@index')->name('seguimiento_docente.index');
    ...
    //Convalidaciones
        ...
        //Tutorias
            //Lista de Tutorias
                ...
                //Tutorias - Clases
                    ...
                    Route::post('tutorias_clases/actualizar_observacion/{id}', 'TutoriaClaseController@update_observacion')->name('tutorias_clases.update_observacion');
                //Tutorias - Evaluaciones
                    ...
                    Route::delete('tutorias_evaluaciones/eliminar_acta/{id}', 'TutoriaEvaluacionController@eliminar_acta')->name('tutorias_evaluaciones.eliminar_acta');
            //Precios
        ...
        //Extensiones Universitarias
            ...
            Route::post('extensiones_universitarias/cargar_informe/{id}', 'ExtensionUniversitariaController@cargar_informe')->name('extensiones_universitarias.cargar_informe');
            ...
            Route::post('extensiones_universitarias/cambiar_adjuntos/{id}', 'ExtensionUniversitariaController@change_adjuntos')->name('extensiones_universitarias.change_adjuntos');
        ...
        //Solicitudes de Alumnos
            ...
            Route::post('solicitudes/aprobar/{id}', 'SolicitudController@approve')->name('solicitudes.approve');
            Route::get('solicitudes/para_entrega/{id}', 'SolicitudController@para_entrega')->name('solicitudes.para_entrega');
            Route::post('solicitudes/para_entrega/{id}', 'SolicitudController@para_entrega')->name('solicitudes.para_entrega');
            Route::get('solicitudes/rechazar/{id}', 'SolicitudController@reject')->name('solicitudes.reject');
            Route::post('solicitudes/rechazar/{id}', 'SolicitudController@reject')->name('solicitudes.reject');
            Route::get('solicitudes/anular_rechazo/{id}', 'SolicitudController@unreject')->name('solicitudes.unreject');
            Route::post('solicitudes/anular_rechazo/{id}', 'SolicitudController@unreject')->name('solicitudes.unreject');
            Route::get('solicitudes/desaprobar/{id}', 'SolicitudController@unapprove')->name('solicitudes.unapprove');
            Route::post('solicitudes/desaprobar/{id}', 'SolicitudController@unapprove')->name('solicitudes.unapprove');
            Route::get('solicitudes/entregar/{id}', 'SolicitudController@deliver')->name('solicitudes.deliver');
            Route::post('solicitudes/entregar/{id}', 'SolicitudController@deliver')->name('solicitudes.deliver');
            Route::get('solicitudes/anular_entrega/{id}', 'SolicitudController@undeliver')->name('solicitudes.undeliver');
            Route::post('solicitudes/anular_entrega/{id}', 'SolicitudController@undeliver')->name('solicitudes.undeliver');
    ...
    //Parametros
        ...
        //Semestres
            ...
            //SemestresMallasMaterias
                ...
                Route::post('semestres_carreras_materias/inactivar/{id}', 'SemestreMallaMateriaController@unactivate')->name('semestres_mallas_materias.unactivate');
                ...
                Route::post('semestres_carreras_materias/activar/{id}', 'SemestreMallaMateriaController@activate')->name('semestres_mallas_materias.activate');
...
//Escuela de Negocios
    //Alumnos
        ...
        Route::post('alumnos_ubs', 'AlumnoUbsController@index')->name('alumnos_ubs.index');
    ...
    //Inscripciones
        ...
        Route::post('inscripciones_ubs', 'InscripcionUbsController@index')->name('inscripciones_ubs.index');
    ...
    //Cursos
        //Lista de Cursos
            ...
            //Alumnos Notas
                ...
                Route::post('cursos_notas/actualizar/{id}', 'CursoNotaController@update')->name('cursos_notas_ubs.update');
            //Certificados
    ...
    //Maestrías
        //Lista de Maestrías
            ...
            //Actas
                ...
                Route::delete('maestrias_actas_evaluaciones/eliminar_acta/{id}', 'ActaEvaluacionUbsController@eliminar_acta')->name('actas_evaluaciones_ubs.eliminar_acta');
        ...
        //Extensiones Universitarias
            //Lista de Extensiones Universtiarias
                ...
                Route::post('extensiones_universitarias_ubs/guardar_horas/{id}', 'ExtensionUniversitariaUbsController@update_hours')->name('extensiones_universitarias_ubs.update_hours');
                ...
                Route::post('extensiones_universitarias_ubs/cargar_informe/{id}', 'ExtensionUniversitariaUbsController@cargar_informe')->name('extensiones_universitarias_ubs.cargar_informe');
                ...
                Route::post('extensiones_universitarias_ubs/cambiar_adjuntos/{id}', 'ExtensionUniversitariaUbsController@change_adjuntos')->name('extensiones_universitarias_ubs.change_adjuntos');
        ...
        //Lista de Tesis
            ...
            //Inscripciones Temas Tesis
                ...
                //Anteproyectos
                    ...
                    Route::post('tesis_ubs/anteproyecto/aprobar_calidad/{id}', 'AnteproyectoTesisUbsController@aprobar_calidad')->name('tesis_ubs.aprobar_calidad_anteproyecto');
    ...
    //Docentes
        ...
        Route::post('docentes_ubs', 'DocenteUbsController@index')->name('docentes_ubs.index');
...
//Compras
    //Ordenes de Compras
        ...
        Route::delete('ordenes_compras/eliminar/{id}', 'OrdenCompraController@destroy')->name('ordenes_compras.destroy');
    ...
    //Compras
        ...
        Route::delete('compras/eliminar/{id}', 'CompraController@destroy')->name('compras.destroy');
    ...
    //Ordenes de Pagos
        ...
        Route::delete('ordenes_pagos/eliminar/{id}', 'OrdenPagoController@destroy')->name('ordenes_pagos.destroy');
...
//Contabilidad
    //Asientos
        ...
        Route::get('asientos_contables/eliminar/{id}', 'AsientoContableController@destroy')->name('docentes_ubs.get_destroy');
    ...
    //Saldo de Cuentas Contables
        ...
        Route::post('cuentas_contables_saldos', 'CuentaContableSaldoController@index')->name('cuentas_contables_saldos.index');
    //Cuentas Contables
...
//Usuarios
    //Lista de Usuarios
        ...
        Route::post('usuarios', 'UserController@index')->name('usuarios.index');
